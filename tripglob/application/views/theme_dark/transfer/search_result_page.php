...
// debug($srch_data); die;
               ...
               <div class="modify-transfer">
                    ...
                    <div class="item">
                        ...
                        <span class="content"> <?php // debug($srch_data['langauge']); die;
                         if($srch_data['from_station_ids']!=""){
                          echo "Airport";
                        }else{
                          echo "Accommodation";
                        } ?></span>
                    ...
                    <div class="item">
                        ...
                        <span class="content">  <?php if($srch_data['to_HotelId']!=""){
                          echo "Accommodation";
                        }else{
                          echo "Airport";
                        } ?></span>
                    ...
                    <div class="item">
                        <img src="../assets/theme_dark/images/placeholder.png" alt="Metro Politian Hotel Icon" class="icon">
                        <span class="content"><?php echo $srch_data['adult']; ?> Adult</span>
                    </div>
                    <div class="item">
                        <img src="../assets/theme_dark/images/clock.png" alt="Clock Icon" class="icon">
                        <span class="content">&nbsp;<?php

                        $hourss = sprintf("%02d", $srch_data['hours']);
                        $minutes = sprintf("%02d", $srch_data['minutes']);

                         echo $hourss.':'.$minutes; ?>hrs</span>
                    </div>
                    <div class="item">
                        ...
                        // $srch_data['langauge']="";
                        // if($srch_data['langauge']!=""){echo $srch_data['langauge'];}else{echo "Not Specified";} 
                          echo $lng; ?>
          ...
          <div class="table-container">
                <table class="custom-table">
                    ...
                    <tbody>
                      ...
                      <?php
              //          debug($raw_transfer_list); die;
                       $vehilce = $raw_transfer_list['TransferSearchResult']['TransferSearchResults'];
                       foreach ($vehilce as $key => $value) {  

                          // debug($value['ResultIndex']);
                        ?>
                        <input type="hidden" name="vehicle_index" id="vehicle_index" value="<?php echo $value['ResultIndex']; ?>">
                        <tr>
                            <td class="description">
                                <p><?php echo $value['Vehicles'][0]['Vehicle']; ?></p>
                                <a href="#" class="more-info more_info_modal" data-desc="<?php echo $value['Description']; ?>" data-tc="<?php echo $value['Condition'][0]; ?>" data-mp="<?php echo $value['meeting_point']; ?>" >More Info</a>
                            </td>
                            <td class="bordered"><?php echo $value['ApproximateTransferTime']; ?></td>
                            <td class="bordered"><?php echo $value['Vehicles'][0]['Vehicle']; ?></td>
                            <td class="bordered"> <?php echo $value['Vehicles'][0]['VehicleMaximumPassengers']; ?></td>
                            <td class="bordered"> <?php echo $value['Vehicles'][0]['VehicleMaximumLuggage']; ?></td>
                            <td class="bordered"> <?php echo $value['Vehicles'][0]['TransferPrice']['PublishedPrice']; ?></td>
                            <td class="bordered">
                                <!-- <button class="action-button FlightbookNow" id="FlightbookNow">Book Now</button> -->
                                <?php $d =array();
                                  ...
                                  // debug($dataa); die;
                                  ?>
                                <a href="<?php echo WEB_URL ?>transfer/addToCart/<?php echo $dataa; ?>">
                    ...
                    <div id="infoModal" class="modal">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <ul class="tab-list">
                                    <li class="tab active" data-tab="description" class="descDiv">Description</li>
                                    <li class="tab" data-tab="transfer-conditions">Transfer Conditions</li>
                                    <li class="tab" data-tab="meeting-point">Meeting Point</li>
                                </ul>
                                <div class="tab-content" id="description" style="display: block;">
                                </div>
                                <div class="tab-content" id="transfer-conditions">
                                </div>
                                <div class="tab-content" id="meeting-point">
                                </div>
                            </div>
...
<script>
$(document).ready(function() {
    // Show the modal on "More Info" button click
    $('.more_info_modal').click(function(e) {
        e.preventDefault();
        $('#infoModal').fadeIn();
    ...
    $('.close-button, .close-modal').click(function() {
        $('#infoModal').fadeOut();
 ...
 $('.more-info').click(function() {
  ...
  $(document).on("click", ".FlightbookNow", function (e) {
    var that = $(this);
          ...
          var att = document.getElementById('vehicle_index').value;
          // alert(att);
          // var action = WEB_URL+'transfer/addToCart';
          var action = WEB_URL+'transfer/addToCart/'+att;
      $.ajax({
        type: "GET",
        url: action,
        data: '',
