...
<div class="container">
  <div class="main_header_iconsaq">
    ...
    <!--</div>-->
  <h1 style="font-weight: 700; color:#000;">Popular Destination</h1>   
 <h4>Travel to iconic destinations at unbeatable prices with Trip Globo!</h4> 
   ...
   <div class="card-container">
    <?php foreach ($flightdeals as $deal): ?>
        <div class="card open-modal">
            <img src="<?php echo base_url('/admin-panel/uploads/flightdeal/' . $deal->deal_image); ?>" alt="Deal Image">
            <div class="card-content">
                <div class="card-text">
                <h2><?php echo $deal->deal_from_place . ' to ' . $deal->deal_to_place; ?></h2>
                <p>Your Gateway to Paradise Awaits!</p>
                </div>
                <div class="price-tag-container">
                    <div class="price-tag">
                         <span style="height:13px">Starting at</span>
                        <span class="price">$<?php echo $deal->deal_offered_price ?></span>
                    </div>
...
<div  style= "display:flex;  align-items:center; justify-content:center; margin-top: 30px;">
  <div class="main_header_iconsaq" style="padding-bottom: 2rem;">
    ...
    <!--      <img class="img-responsive" src="<?php echo base_url(); ?>assets/theme_dark/images/poppoular-icons.png" alt="logo">-->
    <!--</div>-->
  <h2 style="font-weight: 700; color:#000;">Best Hotels Worldwide at Discouted Prices! </h1>   
 <h4>Travel to iconic destinations at unbeatable prices with Trip Globo!</h4> 
 <!-- <p>Showing 30 deals from $39</p>  -->
  </div>
</div>
    ...
    <div class="hotel-card-container row">
        ...
        <div class="hotel-card col-xs-12 col-sm-6">
            ...
            <div class="hotel-card-content">
                ...
                <div class="hotel-price-tag-container">
        ...
        <div class="hotel-card col-xs-12 col-sm-6">
            ...
            <div class="hotel-card-content">
                <div class="hotel-text">
                    <h2>Lakeview Retreat</h2>
                    <p>Experience Tranquility & Comfort!</p>
                </div>
                <div class="hotel-price-tag-container">
  ...
  $('#hotelLoad').click(function(e){
    ...
    // var next_tab = $('.blank_select_hotel > .active');
     ...
     var hash = window.location.hash;
          ...
          {
            // alert('transfer')
             $('#blank_select_transfer').addClass('active');
             $('#blank_select_bus').removeClass('active');
             $('#blank_select_fly').removeClass('active');
             $('#blank_select_hotel').removeClass('active');
             var getHotel= searchPanel('transferSearchPanel','busSearchPanel','flightSearchPanel','hotelSearchPanel');
          }
          else if(hash=='#buses')
          {
            // alert('bus');
             ...
             $('#blank_select_fly').removeClass('active');
             $('#blank_select_hotel').removeClass('active');
             $('#blank_select_transfer').removeClass('active');
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
                ...
                <div class="cont_us">
                  <form action="<?php echo WEB_URL; ?>general/saveSpecialFilghtDetails" method="post">
