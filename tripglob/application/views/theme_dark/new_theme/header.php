...
<div class="topssec" >
  <div class="mobile">
    <button type="button" class="menu_toggle" data-toggle="collapse" data-target="#main_menu"> 
   ...
   <nav class="navbar navme col-m- collapse col-md-9 col-xs-10" id="main_menu">
      <div class="sidall">
        <div class="topmenu">
          <div class="navbdclose">
          <div class="top_items explore_div main_con desk-view-only" style="margin-right: 100px;">
