                    ...
                    list($module, $cid) = explode(',', $cid);    
                      if($module == 'FLIGHT'){
                        ...
                        $cart = $this->cart_model->getBookingTemp_hotel($cid);
                              $Totall[] = $this->Hotel_Model->calculate_hotel_markup($cart->total_cost);
                      ...
                      <div class="sumry_wrap">
                         ...
                         <div class="pre_summery">
                            ...
                            <div class="signing_detis_confirm" <?php  if(!$this->session->userdata('user_id'))
                               ...
                               <div class="clearfix"></div>
                               <?php /*
                               <form id="con_book" method="get" action="<?php echo WEB_URL;?>booking/booking_travellers">
                                  <input type="hidden" id="secdata" name="secdata" value="<?php echo $session_id_c_v; ?>"/>
                                  <input type="hidden" id="pcode" name="pcode" value="<?php echo base64_encode('fool'); ?>"/>
                                  <input type="hidden" id="pcode_d" name="pcode_d" value="0.00"/>
                                  <input type="hidden" id="pcode_f" name="pcode_f" value="<?php echo array_sum($Totall);?>"/>
                                  <input type="hidden" name="search_id" value="<?=@$search_id?>">
                                  <input type="hidden" name="search_module" value="<?=$search_module?>">
                                  <div class="sign_twosec">
                                     <div class="section_sign">
                                        <div class="col-md-6 nopad">
                                           <div class="wrp_pre">
                                              <input type="submit"  class="paysubmit" name="continue_v" id="continue_v" value="Continue" />
                                           </div>
                                        </div>
                                     </div>
                                     <div class="clearfix"></div>
                         ...
                         <div class="wrappay leftboks">
                            ...
                            <div class="col-md-12 nopad">
                               <div class="checkcontent" style="overflow: inherit;">
                                  ...
                                  <label for="squaredThree1" class="lbllbl">By booking this item, you agree to pay the total amount shown, which includes Service Fees5, on the right and to the<a data-toggle="modal" data-target="#terms_n_conditions" class="colorbl"> Terms &amp; Conditions</a>.</label>
                               </div>
                            </div>
