                     ...
                     <div class="wrappay leftboks">
                        ...
                        <div class="col-md-12 nopad">
                           <div class="checkcontent" style="overflow: inherit;">
                              ...
                              <label for="squaredThree1" class="lbllbl">By booking this item, you agree to pay the total amount shown, which includes Service Fees2, on the right and to the<a data-toggle="modal" data-target="#terms_n_conditions" class="colorbl"> Terms &amp; Conditions</a>.</label>
                           </div>
                        </div>
