         ...
         <div class="container martopbtm">
            <div class="paymentpage">
               <?php 
                  $Acount = 0;$Fcount = 0;$Hcount = 0;$Ccount = 0;$Bcount = 0;$Car_count = 0;$sight_count = 0;$transfer_count=0;$Car_v1_count = 0;
                    ...
                    // debug($search_id); exit();
                      ...
                      $module_final1=base64_encode(json_encode($module));
                      }else{
                      $module_final1=base64_encode(json_encode($module_final));
                        
                      }
                  
                  // debug(json_decode(base64_decode($module_final1)));exit();
                    ...
                    //   echo "<pre>";print_r($price_summary);die;
               ...
               <div class="col-md-8 col-sm-8 nopad fulbuki">
                  <form name="checkout-apartment" method="post"  action="<?php echo WEB_URL;?>booking/checkout">
                     <?php if($this->session->userdata('user_type') == '1'){ ?>
                     ...
                     <div class="col-md-12 col-sm-12 nopad fulbuki">
                        <div class="sumry_wrap">
                           ...
                           <div class="pre_summery">
                              ...
                              <?php
                                 for($s=0;$s<count($segment_data);$s++){  
                                  for($ss=0;$ss<count($segment_data[$s]['dateOfDeparture']);$ss++){
                                    ...
                                    <div class="waymensn">
                                       <div class="flitruo cloroutbnd">
                                          <div class="detlnavi">
                                             ...
                                             <div class="col-xs-2 nopad padflt widfty">
                                                <div class="lyovrtime">
                                                   <span class="flect"> <span class="fa fa-clock-o"></span> <?php

                                                    echo $segment_data[$s]['segment_duration'][$ss]; ?></span>
                                                   <?php if(false){ ?>
                           ...
                           <div class="pre_summery">
                              ...
                              //debug($segment_data);
                                 for($seg=0;$seg<count($segment_data['Segments']);$seg++){ 
                                 for($ss=0;$ss<count($segment_data['Segments'][$seg]);$ss++){ 
                            //   debug($segment_data['Segments'][0][$ss]);
                              ...
                              <div class="sidenamedesc">
                                 <div class="celhtl width20 midlbord">
                                    <div class="fligthsmll">
                                       <img alt="" src="<?php echo 'https://c.fareportal.com/n/common/air/ai/'.$segment_data['Segments'][0][$ss]['Airline']['AirlineCode'].'.gif'; ?>">
                                       <?php
                                          $airline_code .= $segment_data['Segments'][0][$ss]['Airline']['AirlineCode'].';';
                                          
                                          ?>
                                       <div class="flitsmdets">
                                          <?php echo $segment_data['Segments'][0][$ss]['Airline']['AirlineName']; ?> <strong> <?php echo $segment_data['Segments'][0][$ss]['Airline']['FlightNumber']; ?><br>
                                          </strong>
                                       </div>
                                    </div>
                                    <?php //echo //$onwards_f[$s]->TfClass;?>
                                 ...
                                 <div class="celhtl width80">
                                    <div class="waymensn">
                                       <div class="flitruo cloroutbnd">
                                          <div class="detlnavi">
                                             <div class="col-xs-4 padflt widfty">
                                                <div class="rndplace"><?php echo $segment_data['Segments'][$seg][$ss]['Origin']['Airport']['AirportName']; ?> <span class="timlbl right"> <span class="flname">(<?php echo $segment_data['Segments'][$seg][$ss]['Origin']['Airport']['AirportCode']; ?>)</span> </span></div>
                                                <div class="clearfix"></div>
                                                <span class="flitrlbl elipsetool"><?php echo date("M d Y, h:i:sa", strtotime($segment_data['Segments'][$seg][$ss]['Origin']['DepTime'])); ?> <span class="fltime"><?php //echo date("H:i", strtotime($segment_data['Segments'][0][$ss]['Origin']['DepTime'])); ?></span></span>
                                             </div>
                                             <div class="col-xs-2 nopad padflt widfty">
                                                <span class="fadr fa fa-long-arrow-right textcntr" style="font-size: 15px; line-height: 30px;"> </span>
                                             </div>
                                             <div class="col-xs-4 padflt widfty">
                                                <div class="rndplace"><?php echo $segment_data['Segments'][$seg][$ss]['Destination']['Airport']['AirportName']; ?> <span class="timlbl"> <span class="flname">(<?php echo $segment_data['Segments'][$seg][$ss]['Destination']['Airport']['AirportCode']; ?>)</span> </span></div>
                                                <div class="clearfix"></div>
                                                <span class="flitrlbl elipsetool"><?php echo date("M d,Y, h:i:sa", strtotime($segment_data['Segments'][$seg][$ss]['Destination']['ArrTime'])); ?> <span class="fltime"><?php //echo $segment_data[$s]['ArrivalTime'][$ss]; ?></span></span>
                                             </div>
                                             <div class="col-xs-2 nopad padflt widfty">
                                                <div class="lyovrtime">
                                                   <span class="flect"> <span class="fa fa-clock-o"></span> <?php
                                                       // debug($segment_data['Segments'][$seg][$ss]['Duration']);exit();
                                                         echo secondstominutes($segment_data['Segments'][$seg][$ss]['Duration']*60) ;?></span>
                                                   <?php if(false){ ?>
                           ...
                           <div class="pre_summery">
                              ...
                              <div class="sidenamedesc">
                                 ...
                                 </div><?php //debug($cart); exit(); ?>
                                 <div class="celhtl width100">
                                    <div class="waymensn" style="padding:10px">
                                       <span class="fltime">Cancellation Policy : </span> <?php
                                          if (empty($cancelpolicy[0]['cancel_policy'])) {
                                             echo "Non Refundable";
                                           } else {
                                             echo $cancelpolicy[0]['cancel_policy'];
                                           }
                                 ...
                                 <div class="sign_twosec">
                                    <div class="section_sign" id="i_have_account">
                                       <div class="col-md-7 nopad">
                                          ...
                                          <div class="clearfix"></div>
                                          <div class="wrp_pre">
                                             <input type="submit" class="paysubmit" name="continue" value="Continue" required/>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="clearfix"></div>
                                       ...
                                       <div class="col-md-7 nopad">
                                          <div class="wrp_pre">
                                             <div class="col-xs-5 nopad">
                                                <select class="form-control pre_put newslterinput nputbrd _numeric_only" id="before_country_code" required>
                                                <?php
                                             ...
                                             <div class="col-xs-6 nopad">
                                                <input type="text" maxlength="12" name="pn_mobil_no" data-mask="000000000000" class="form-control pre_put" required placeholder="Mobile Number" id="booking_user_mobile"required>
                        ...
                        <div class="sumry_wrap">
                           <div class="wrappay leftboks">
                              <div class="comon_backbg">
                                 ...
                                 if($Fcount > 0 || $Hcount > 0 || $Ccount > 0|| $Bcount > 0 || count($cart_global)==2){ ?>              
                                    ...
                                    <div class="collapse in" id="collapse102">
                                       ...
                                       <div class="onedept">
                                             ...
                                             <div class="repeatprows">
                                                ...
                                                <div class="col-md-2 set_margin">
                                                   ...
                                                   <div class="selectedwrap">
                                                      <select class="flpayinput" name="a_gender<?php echo $cid; ?>[<?php echo $k; ?>]"required>
                                                         <option value="Male">Mr.</option>
                                                         <option value="Female">Mrs./Miss.</option>
                                                      </select>
                                                      <input type="hidden" name="search_request" value="<?=base64_encode(json_encode($request))?>" required/>
                                                   </div>
                                                </div>
                                                ...
                                                <div class="col-md-4 set_margin">
                                                   ...
                                                   <input placeholder="Passport No." value="<?php if($k == 0){ echo $passport_number;}?>" name="apass<?php echo $cid;?>[<?php echo $k; ?>]" class="payinput" type="text"  maxlength="12"  required/> 
                                                </div>
                                                <div class="col-md-4 set_margin">
                                          ...
                                          <div class="payrow">
                                             <div class="repeatprows">
                                                ...
                                                <div class="col-md-2 set_margin">
                                                   <div class="paylabel">Title<span class="required">*</span></div>
                                                   <div class="selectedwrap">
                                                      <select class="flpayinput" name="c_gender<?php echo $cid; ?>[<?php echo $k; ?>]"required>
                                                         <option value="Male">Mr.</option>
                                                         <option value="Female">Mrs./Miss.</option>
                                                      </select>
                                                   </div>
                                                ...
                                                <div class="col-md-4 set_margin">
                                                   <div class="paylabel">First Name<span class="required">*</span></div>
                                                   <input placeholder="First Name" name="cfirst_name<?php echo $cid;?>[<?php echo $k; ?>]" type="text" class="payinput mytextbox" value=""required/>
                                                </div>
                                                <div class="col-md-4 set_margin">
                                                   <div class="paylabel">Last Name<span class="required">*</span></div>
                                                   <input placeholder="Last Name" name="clast_name<?php echo $cid;?>[<?php echo $k; ?>]" type="text" class="payinput mytextbox"required/>
                                                </div>
                                                <div class="col-md-2 set_margin">
                                                   <div class="paylabel">Date Of Birth<span class="required">*</span></div>
                                          ...
                                          <div class="payrow">
                                             <div class="repeatprows">
                                                ...
                                                <div class="col-md-2 set_margin">
                                                   <div class="paylabel">Title<span class="required">*</span></div>
                                                   <div class="selectedwrap">
                                                      <select class="flpayinput" name="i_gender<?php echo $cid; ?>[<?php echo $k; ?>]"required>
                                                         <option value="Male">Mr.</option>
                                                         <option value="Female">Mrs./Miss.</option>
                                                      </select>
                                                   </div>
                                                ...
                                                <div class="col-md-4 set_margin">
                                                   <div class="paylabel">First Name<span class="required">*</span></div>
                                                   <input placeholder="First Name" name="ifirst_name<?php echo $cid;?>[<?php echo $k; ?>]" type="text" class="payinput mytextbox" value=""required/>
                                                </div>
                                                <div class="col-md-4 set_margin">
                                                   <div class="paylabel">Last Name<span class="required">*</span></div>
                                                   <input placeholder="Last Name" name="ilast_name<?php echo $cid;?>[<?php echo $k; ?>]" type="text" class="payinput mytextbox"required/>
                                                </div>
                                                <div class="col-md-2 set_margin">
                                                   <div class="paylabel">Date Of Birth<span class="required">*</span></div>
                                          ...
                                          <?php $i++; }
                                             ...
                                             // debug(json_decode(base64_decode($page_data['selected_seat_response'][0])));exit();
                                          ...
                                          <div class="onedept">
                                             <!-- <div class="evryicon"><span class="fa fa-bed"></span></div> -->
                                             <div class="pasenger_location">
                                                <input type="hidden" required="required" name="token"   value="<?=$dynamic_params_url;?>" required/>
                                                <input type="hidden" required="required" name="token_key" value="<?=md5($dynamic_params_url);?>" required/>
                                                <input type="hidden" required="ResultToken" name="ResultToken"  value="<?=$pre_booking_params['ResultToken'];?>"required/>
                                             ...
                                             <div class="payrow">
                                                <div class="repeatprows">
                                                   ...
                                                   <div class="col-md-2 set_margin">
                                                      <div class="selectedwrap">
                                                         <select class="flpayinput" name="bgender[<?php echo $k; ?>]"required>
                                                            <option value="Mr">Mr</option>
                                                            <option value="Mrs">Mrs</option>
                                                            <option value="Miss">Miss</option>
                                                         </select>
                                 ...
                                 <div class="sectionbuk billingnob collapse" id="demo" >
                                    <div class="payrow">
                                       ...
                                       <div class="col-md-6 set_margin">
                                          ...
                                          <input type="text" id="gst_reg_no" name="gst_reg_no" class="payinput " minlength="8" maxlength="16" data-rule-number= "true"/>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              <div class="comon_backbg">
                                 ...
                                 <div class="sectionbuk billingnob">
                                    ...
                                    <input type="hidden" name="BlockTourId" value="<?=@$cart->BlockTourId?>"required>
                                    <input type="hidden" name="cid" id="cid" value="<?php echo @$cart_global_id;?>"required/>
                                    <div class="payrow">
                                       <div class="col-md-4 set_margin">
                                          <div class="paylabel">Country Code<span class="required">*</span></div>
                                          <select class="form-control payinput  newslterinput nputbrd _numeric_only" id="before_country_code" required name="mobile_code"required>
                                          <?php
                                             echo diaplay_phonecode($phone_code, $user_country_code); ?>
                                          </select>
                                       </div>
                              ...
                              <div class="comon_backbg">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-check" style="border: 1px solid #ddd;margin: 10px;padding: 5px;border-radius: 10px;">
                                            <input class="form-check-input" type="radio" name="payment_gateway" id="payu" value="payu" checked>
...
<!-- Modal -->
<div class="modal fade" id="terms_n_conditions" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Modal title</h5>
        <button type="button" class="close temr_close" data-dismiss="modal" aria-label="Close">
      ...
      <div class="modal-footer ">
        <button type="button" class="btn btn-secondary temr_btn" data-dismiss="modal">Close</button>
      </div>
    </div>
  </div>
</div>
                              ...
                              <?php if (is_array($bt['session_id_xc'])) {
                                 // debug($bt['session_id_xc']);exit();
                               $bt['session_id_xc'] = $bt['session_id_xc']['s_session_id'] ;?>
                              <input type="hidden" name="session_id_round" value="round"/>
                              ...
                              <div class="cartlistingbuk">
                                    ...
                                    <div class="col-md-8 celcart">
                                     ...
                                     <div class="col-md-4 celcart">
                                       <div class="cartprc">
                                          ...
                                          <?php 
                                          $basefare_after_markup = $pricing_details['BaseFare']; ?>
                                          <!-- <div class="ritaln cartcntamnt normalprc"><?php echo BASE_CURRENCY_ICON?><?= $price_summary['taxes'] ?></div> -->
                                          <div class="ritaln cartcntamnt normalprc"><?php echo $this->display_icon?> <?= number_format(($basefare_after_markup * $this->curr_val), 2); ?></div>
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="cartitembuk">
                                    ...
                                    <div class="col-md-4 celcart">
                                       <div class="cartprc">
                                          <?php //$total_after_markup = ($admin_markup[0]->admin_markup)+($pricing_details[0]['PriceInfo']['totalTaxAmount']); ?>
                                          <?php $total_after_markup = ((array_sum($Totall))-($pricing_details['Tax']+$pricing_details['BaseFare']))+($pricing_details['Tax']); ?>
                                          <!-- <div class="ritaln cartcntamnt normalprc"><?php echo BASE_CURRENCY_ICON?><?= $price_summary['taxes'] ?></div> -->
                                          <div class="ritaln cartcntamnt normalprc"><?php echo $this->display_icon?> <?= number_format(($total_after_markup * $this->curr_val), 2); ?></div>
                                       </div>
                                    </div>
                                 ...
                                 <div>
                                    <a href="<?=$_SERVER['HTTP_REFERER']?>" class="primary cancel_booking_details" id="">Cancel</a>
                                 </div>
                              </div>
                              <div class="clear"></div>
                                    ...
                                    <div class="col-md-4 celcart">
                                       <div class="cartprc">
                                          <?php
                                             ...
                                             $total_value = $CI->currency_converter->convert(BASE_CURRENCY,'INR',$price_val);
                                       ...
                                       <div class="cartprc">
                                          ...
                                          <div class="ritaln cartcntamnt bigclrfnt finalAmt">
                                             <select class="form-control" id="currency_list">
                                                ...
                                                <option <?php if($data->currency_code == 'INR'){echo 'selected';} ?> value="<?php echo $data->currency_code; ?>"><?php echo $data->currency_name; ?></option>
                                                <?php } ?>
                                             </select>
                                          </div>
                                       </div>
                                    ...
                                    <div class="col-md-8 col-xs-8 nopadding_right">
                                       <div class="cartprc">
                                          ...
                                          <div class="payblnhm singecartpricebuk ritaln">
                                             <input type="text" class="promocode" id="code" name="code" placeholder="Enter Promo"/>
                                          </div>
                                       </div>
                                    </div>
      ...
      <script type="text/javascript">
         ...
         $(document).ready(function(){
             ...
             $('#currency_list').on('change', function() {
                 ...
                 var code = this.value;
                    console.log({total_amount:total,currency_code:code});
                 $.ajax({
