...
<div class="top80">
                    ...
                    <table width="95%" border="0" align="center" cellpadding="8" cellspacing="0" style="margin:0 auto;">
                      ...
                      <!--   <tr>
                       ...
                       <tr>
                        ...
                        <?php 
      $segment_data1 = json_decode($Booking->segment_data,1);
      $segment_data = $segment_data1['Segments'];
    //  echo "<pre/>";print_r($segment_data);exit("176");
      ?>
 ...
 <?php for($s=0;$s<count($segment_data);$s++){ 
    ...
    for($ss=0;$ss<count($segment_data[$s]);$ss++){ ?>
                      ...
                      <table class="col-xs-12 ways_one nopad">
                            <tr class=" nopad" style="padding-bottom: 20px;">
                              <td colspan="4" style="padding-bottom: 10px;">
                                <table style="width: 100%;" bgcolor="#f8f8f8" class="hedtowr destination_heading" style="padding: 8px 15px;border-bottom: 1px dashed #ddd;color: #333;display: block;font-size: 14px; font-weight: normal;overflow: hidden;background: #f8f8f8;">
                                  <tr>
                                    <td colspan="4">
                                     <?php echo $segment_data[$s][$ss]['Origin']['Airport']['AirportName']; ?> <span class="fa fa-arrow-right"></span>  <?php echo $segment_data[$s][$ss]['Destination']['Airport']['AirportName']; ?>
                                   </td>
                                   </tr>
                                </table>
                              </td>
                            ...
                            <tr>
                              <td>
                                 ...
                                 <table class="flitone" style="width: 100%;display: table;    padding: 10px 10px;border: 1px solid #eee;">

                                  <tr>
                                    <td class="nopad5 width_hundred" style="padding: 10px 10px;">
                  ...
                  <?php 
                   ...
                   ?>
                                   ...
                                   <td class="padflt widfty"  style="padding: 10px 10px;">
                            <span class="timlbl" style="padding-bottom: 6px;">
                              <span class="flname"><?php echo $segment_data[$s][$ss]['Origin']['Airport']['CityName']; ?> </span><br><span class="fltime" style="text-align: center;font-size: 16px;"><?php echo date("H:i", strtotime($ddd[1]));  ?></span>
                            </span>
                            <div class="clearfix"></div>
                                                        <div class="clearfix"></div>
                            <span class="flitrlbl elipsetool" style=""><?php echo date("M d,Y", strtotime($ddd[0]));  ?> </span>
                          </td>
                          <?php 
                          ...
                          <td class="nopad padflt widfty"  style="padding: 10px 10px;">
                            <div class="lyovrtime"> 
                              <span class="flect" style="padding-bottom: 6px;"> <span class="fa fa-clock-o"></span> <?php echo $hours.'h:'.$minutes.'m'; ?></span>
                               <img src="<?php echo ASSETS;?>images/arrow.jpg" style="width:100px;display: block;margin: 0 auto;" >
                             <!--  <div class="termnl1">Change Clock : <?php echo ($segment_data[$s]->DepartureTimeZone[$ss] - $segment_data[$s]->ArrivalTimeZone[$ss])." Hours"; ?></div> -->
                            </div>  
                          </td>
                        ...
                        <td class="padflt widfty"  style="padding: 10px 10px;">
                          <span class="timlbl " style="text-align: center">
                            <p class="flname" style=""><?php echo $segment_data[$s][$ss]['Destination']['Airport']['CityName']; ?> </p><span class="fltime" style="    font-size: 16px;"><?php echo date("H:i", strtotime($aaa[1]));  ?></span> 
                            
                          </span>
                          <div class="clearfix"></div>
                                                    <div class="clearfix"></div>
                          <span class="flitrlbl elipsetool" style="text-align: center;"><?php echo date("M d,Y", strtotime($aaa[0]));  ?></span>
                        </td>
