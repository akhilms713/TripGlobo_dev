...
// debug($selected_seat_response);exit;
							...
							<div class="fredivs">
							   ...
							   <div class="reptalltftr">
									...
									<div class="col-xs-4 nopadding">
										...
										<div class="amnterbus arimobold grandtotal"><?=$default_currency_symbol?> <?=roundoff_number($markup_total_fare)?> </div>
								...
								<div class="clearfix"></div>
								 ...
								 <div class="reptalltftr">
									...
									<div class="col-xs-4 nopadding">
										...
										<div class="amnterbus arimobold grandtotal"><?=$default_currency_symbol?> <?=roundoff_number($convenience_fees)?> </div>
								...
								<div class="reptalltftr">
									...
									<div class="col-xs-4 nopadding">
										...
										<div class="amnterbus arimobold grandtotal"><?=$default_currency_symbol?> <?=roundoff_number($gst_value)?> </div>
								...
								<div class="reptalltftr">
									...
									<div class="col-xs-4 nopadding">
										...
										<div class="amnterbus arimobold grandtotal"><?=$default_currency_symbol?> <?=roundoff_number($markup_total_fare+$gst_value+$convenience_fees)?> </div>
...
<?php //debug($CUR_Route);exit;?>
							...
							<div class="moreflt boksectn">
							  ...
							  <div class="ontyp">
								...
								<div class="labltowr arimobold"><?php echo $details['origindestination'][0]['Origin'];?> to <?php echo $details['origindestination'][0]['Destination'];?><strong>(<?=get_time_duration_label(calculate_duration($CUR_Route['DepartureTime'], $CUR_Route['ArrivalTime']))?>)</strong></div>

								<div class="allboxflt">

								  <div class="col-xs-4 nopadding full_fiftys">

									<div class="alldiscrpo"><?=$CUR_Route['TravelName']?>
									...
									<span class="pikuptm">
										...
										// debug($bus_pickup);exit;

										$pickup = $bus_pickup[$pre_booking_params['pickupId']]; 

										echo $pickup['CityPointName'];
										...
										<?php echo get_time($pickup['CityPointTime']);	?>
									...
									<span class="pikuptm">
										...
										$drop = $bus_drop[$pre_booking_params['dropId']]; 

									

										echo $drop['CityPointName'];
										...
										<?php echo get_time($drop['CityPointTime']);	?>
								  ...
								  <div class="col-xs-6 nopadding qurter_wdth">
									...
									<div class="col-xs-5 nopad">
										...
										<span class="airlblxl"><?=($CUR_Route['DepartureTime'])." ".get_time($CUR_Route['DepartureTime'])?></span>

										<span class="portnme"><?php echo $details['origindestination'][0]['Origin'];?></span>	
									...
									<div class="col-xs-5 nopad">
										...
										<span class="airlblxl"><?=($CUR_Route['ArrivalTime'])." ".get_time($CUR_Route['ArrivalTime'])?></span>

										<span class="portnme"><?php echo $details['origindestination'][0]['Destination'];?></span></div>
					  ...
					  <div class="labltowr arimobold"><?php echo $details['origindestination'][0]['Origin'];?> to <?php echo $details['origindestination'][0]['Destination'];?><strong>(<?=get_time_duration_label(calculate_duration($CUR_Route['DepartureTime'], $CUR_Route['ArrivalTime']))?>)</strong></div>
								...
								<div class="col-xs-3 nopadding full_fiftys">
									...
									<div class="pikuplokndt">
										...
										<?php $pickup = $bus_pickup[$pre_booking_params['pickupId']]; 
								...
								<div class="col-xs-7 nopadding qurter_wdth">
									...
									<div class="col-xs-5">
										...
										<span class="airlblxl"><?=local_date($CUR_Route['DepartureTime'])." ".get_time($CUR_Route['DepartureTime'])?></span>
									...
									<div class="col-xs-5">
										...
										<span class="airlblxl"><?=local_date($CUR_Route['ArrivalTime'])." ".get_time($CUR_Route['ArrivalTime'])?></span>
						...
						<div class="pasngrinput_enter">
							...
							<div class="hide hidden_pax_details">
								...
								<div class="pad_psger">
									...
									<span class="seat_number"> Seat <strong><?=$i_seat['SeatIndex']?></strong></span>
										...
										<div class="pad_psger">
												...
												<input value="<?=@$cur_pax_info['first_name']?>" type="text" maxlength="45" id="contact-name"  name="first_name[]" class="clainput  alpha_space <?=$traveller_class?>" required placeholder="First Name" data-row-id="<?=($i);?>">
										...
										<div class="pad_psger">
												...
												<input value="<?=@$cur_pax_info['last_name']?>" type="text" maxlength="45" id="contact-name"  name="last_name[]" class="clainput  alpha_space <?=$traveller_class?>" required placeholder="Last Name" data-row-id="<?=($i);?>">
										...
										<div class="pad_psger">
												...
												<input value="<?=@$cur_pax_info['phone_number'] == 0 ? '' : @$cur_pax_info['phone_number'];?>" type="text" name="phone_number[]" placeholder="Mobile Number" class="newslterinput nputbrd _numeric_only numeric" maxlength="10" required="required" data-row-id="<?=($i);?>">
										...
										<div class="pad_psger">
												...
												<input value="<?=@$cur_pax_info['email']?>" type="text" maxlength="80" required="required"  class="newslterinput nputbrd" placeholder="Email" name="email[]" data-row-id="<?=($i);?>">
										...
										<div class="pad_psger">
											...
											<div class="selectedwrap">
												...
												<select class="age flyinputsnor" name="gender[]" id="gender-<?=($i);?>" required>
										...
										<?php if ($details['origindestination'][0]['BusResults'][0]['IdProofRequired'] == true) { ?>
										...
										<div class="pad_psger">
											...
											<div class="selectedwrap">
												...
												<select class="age flyinputsnor" name="id_type[]" id="id_type-<?=($i);?>" required>
										...
										<div class="pad_psger">
												...
												<input value="<?=@$cur_pax_info['id_number'] == 0 ? '' : @$cur_pax_info['id_number'];?>" type="text" name="id_number[]" placeholder="Id Number" class="newslterinput nputbrd _numeric_only numeric" maxlength="15" required="required" data-row-id="<?=($i);?>">
							...
							$dynamic_params_url['JourneyDate'] = $details['journey_date'];
							...
							$dynamic_params_url['selected_seats_no'] = $pre_booking_params['seat'];

							$dynamic_params_url['DepartureTime'] = $CUR_Route['DepartureTime'];

							$dynamic_params_url['ArrivalTime'] = $CUR_Route['ArrivalTime'];

							$dynamic_params_url['departure_from'] = $details['origindestination'][0]['Origin'];

							$dynamic_params_url['arrival_to'] = $details['origindestination'][0]['Destination'];
							...
							$dynamic_params_url['bus_type'] = $CUR_Route['BusType'];

							$dynamic_params_url['operator'] = $CUR_Route['TravelName'];
							...
							$dynamic_params_url['CancPolicy'] = base64_encode(json_encode($pre_booking_params['bus_res']['CancellationPolicies']));
