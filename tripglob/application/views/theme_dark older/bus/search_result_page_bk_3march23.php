...
<div class="col-md-12 nopad">
                     ...
                     <div class="text-center pdt15"><span id="total_records"></span><!--  Buses <span>found</span> --></div>
...
<!-- 
                  ...
                  <div class="col-md-2 nopad">
                        ...
                        <div class="flight_list active">
                    <a class="sorta active dep_bus" type="depature_time" id="depart_sort" val="desc"> <i class="fal fa-calendar-check"></i> Departure</a>
                       </div>
                  ...
                  <div class="col-md-2 nopad">
                       ...
                       <a class="sorta dep_bus" type="arrival_time" id="arrival_sort" val="asc"><i class="fal fa-clock"></i> Duration</a>
                  ...
                  <div class="col-md-2 nopad">
                      ...
                      <div class="flight_list">
                   <a class="sorta dep_bus" type="arrival_time" id="arrival_sort" val="asc"><i class="fal fa-clock"></i> Arrival Time</a>
                     </div>
                  ...
                  <div class="col-md-2 nopad">
                     ...
                     <a class="sorta dep_bus" type="arrival_time" id="arrival_sort" val="asc"><span class="fa fa-star-o"></span> Rating</a>
                  ...
                  <div class="col-md-2 nopad">
                         ...
                         <div class="flight_list">
                                <a class="sorta dep_bus" type="arrival_time" id="arrival_sort" val="asc"> <i class="fa fa-puzzle-piece" aria-hidden="true"></i> Seats Available</a>
                  ...
                  <div class="col-md-2 nopad">
                        ...
                        <div class="flight_list">
                          <a class="sorta dep_bus" type="arrival_time" id="arrival_sort" val="asc"><i class="fa fa-ticket" aria-hidden="true"></i> Fare</a>
