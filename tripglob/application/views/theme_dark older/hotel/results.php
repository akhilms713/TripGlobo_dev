		...
		<div class="container">
			<div class="contentsdw">
				<div class="col-lg-4 col-md-4 col-sm-8 col-xs-8 nopad">
					<div class="pad_ten">
						<div class="left_icon sprite marker_icon"><i class="cus-fa-icon fas fa-map-marker-alt"></i></div>
				...
				<div class="col-lg-4 col-xs-6 hidden-sm hidden-xs nopad">
					<div class="col-xs-6 nopad">
						<div class="pad_ten">
							<div class="left_icon sprite calendar_icon"><i class="cus-fa-icon far fa-calendar-alt"></i></div>
							<div class="from_to_place">
				...
				<div class="col-lg-2 hidden-md hidden-sm hidden-xs nopad">
					<div class="pad_ten">
						<div class="left_icon sprite pasnger_icon"><i class="cus-fa-icon far fa-user"></i></div>
						<div class="from_to_place">
							<div class="boxlabl textcentr"><strong><?php echo array_sum($request_data['adult'])+array_sum($request_data['child']); ?></strong>Guest(s)</div>
			...
			<div class="col30">
				...
				<button class="close_filter"><span class="fa fa-close"></span></button>
					...
					<div class="norfilterr">
						<div class="outbnd">
							<div class="rangebox">
								<div class="ranghead" data-toggle="collapse" data-target="#collapse-hotel-name" aria-expanded="true" aria-controls="collapse-hotel">Hotel Name</div>
                                   <div id="collapse-hotel-name" class="collapse show" aria-expanded="true" style="height: 0px;">
							...
							<div class="rangebox">
								<div class="ranghead" data-toggle="collapse" data-target="#collapse-hotel_price" aria-expanded="true" aria-controls="collapse-hotel">Price</div>
								<div class="collapse show" id="collapse-hotel_price" aria-expanded="true">
							...
							<div class="rangebox">
								<div class="ranghead" data-toggle="collapse" data-target="#collapse-hotel_start" aria-expanded="true" aria-controls="collapse-hotel">Star Rating</div>
								<div id="collapse-hotel_start"  class="collapse show">	
    ...
    var a = ['TBO'];
		...
		function nextCall() {
            ...
            $.ajax({
                ...
                data: { request: '<?php echo $request_data_enc; ?>',page:"<?= (isset($_GET['page']) && $_GET['page'] != "")?$_GET['page']:0 ?>"},
                dataType: "json",
                beforeSend: function () {
                    $(".nextpage").hide();
                    $('.imgLoader').fadeIn();
