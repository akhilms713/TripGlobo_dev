    ...
    <div class="load_inner">
      <div class="relativetop">
        ...
        <div class="progress-bar" role="progressbar" aria-valuenow="45" aria-valuemin="0" aria-valuemax="100" style="width: 0%;transition-duration:50ms;">Fetching Results....</div>
          ...
          <img src="<?php echo ASSETS; ?>images/bus_deal.gif" alt="logo" style="width: 26%;"margin-top:
          78px;/>
          <img src="<?php echo ASSETS; ?>images/hotel-loader.png" alt="logo" style="width: 16%;"/>
             ...
             <div class="tablecelfty">
              <div class="borddo brdrit">
                <div class="fuldate"> <span class="bigdate"><?php echo date('d', strtotime($request_data['hotel_checkin'])); ?></span>
                  <div class="biginre"><span> <?php echo date('M', strtotime($request_data['hotel_checkin'])); ?></span>
                    
                    <span><?php echo date('Y', strtotime($request_data['hotel_checkin'])); ?></span>
                      </div>
                </div>
              </div>
            </div>
          ...
          <div class="ffty">
            ...
            <div class="tablecelfty">
              <div class="borddo">
                  ...
                  <div class="biginre"> <span> <?php echo date('M', strtotime($request_data['hotel_checkout'])); ?></span>
<span>                    <?php echo date('Y', strtotime($request_data['hotel_checkout'])); ?>  </span>
</div>
                </div>
              </div>
            </div>
