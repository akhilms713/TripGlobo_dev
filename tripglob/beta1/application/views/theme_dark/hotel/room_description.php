					  ...
					  <?php  	
					   ...
					   <div class="htl_rumrow">
						...
						<div class="col-md-12 nopad bordrit">
							<div class="pricesec">
								<div class="sideprice">  <?=BASE_CURRENCY_ICON?> <?php echo (($value['Price']['PublishedPrice']) + $admin_markup);?><span class="avgper"></span> </div>
								<form action="<?=base_url();?>hotel/add_cart" method="post" target="_blank" id="hotel_booking">
                            		...
                            		<input type="hidden" name="RoomTypeCode" value="<?php echo base64_encode(json_encode($value['RoomTypeCode']));?>">
                            		<input type="hidden" name="RoomTypeName" value="<?php echo base64_encode(json_encode($value['RoomTypeName']));?>">
                            		<input type="hidden" name="RatePlanCode" value="<?php echo base64_encode(json_encode($value['RatePlanCode']));?>">
                            		...
                            		<input type="hidden" name="room_price" value="<?php echo base64_encode(json_encode($value['Price']['PublishedPrice'] + $admin_markup));?>">
