...
//   {
   ...
   // }
    ...
    $bus_fare = $__bv['BusPrice']['PublishedPriceRoundedOff'] + @$__bv['BusPrice']['admin_markup'];
   // debug($bus_fare);die;
...
?>
  ...
  <style type="text/css">
   ...
   <div class="col-md-12  main_bus_details busrows r-r-i">
...
$seconds = $parsed['hour'] * 60 + $parsed['minute'];
     ...
     <!--  <div class="col-md-1 nopad">
         ...
         <h2> <i class="fa fa fa-star"></i>1.3</h2>
      ...
      <div class="col-md-2 nopad">
         ...
         <!-- <h6 class="addtionl_seat">20 Window</h6> -->

      </div>

      <div class="col-md-2 nopad checking bus_price" data-price="<?=$bus_fare?>">
      ...
      <div class="col-md-12 amintis_newdw">
         ...
         <div class="tab_o">
            ...
            <ul>
               ...
               <li class="tablinks amenities-show" id="">
                  ...
                  <!--   <button class ="amenities-summary-btn" >Amenities</button>-->
