<style type="text/css">
   ...
   .brdr_bx{padding: 0;border: 2px solid #fdb813; margin-bottom:4px;
    background:#fff;}
               ...
               <div class="col-sm-12 nopad">
                <div class="col-sm-12 col-xs-12 ">
                 <div class="brdr_bx">
                  ...
                  <div class="city_middl_text">
                     <input type="text" required  placeholder="Region, City, Area (Worldwide)" class="ft hotelCityIp iconLoc contr_form hotel_city_search" id="city" name="city" value="<?php if(isset($city)) { echo $city.' , '.$country; } else { echo @$hotel_search_params['location']; } ?>">
                  </div>
