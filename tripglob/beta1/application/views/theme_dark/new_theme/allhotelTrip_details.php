      ...
      <div class="clearfix"></div>
		...
		<div class="container cont_pad">
			...
			<div class="col-md-10 fgt_secss">
		    	 <h2><center>All Hotel Trip Details</center></h2><br><br>
		    	 <div class="col-md-1"></div>
			     <div class="col-md-12">
			     	<table class="table">
			     	    <tr>
			     	    ...
			     	    $i=1;
			     	       foreach($hotel_details as $key => $vals)
			     	       {
			     	    ...
			     	    <tr>
			     	        <td><?= $i++;?></td>
			     	         <td><?php echo $vals['module_name']?></td>
			     	        <td><?php echo $vals['city_name'];?></td>			     	        
			     	        <td><?php echo $vals['checkin_date']?></td>
			     	        <td><?php echo $vals['checkout_date']?></td>
			     	        <td><?php echo $vals['checkin_time'];?></td>
			     	        <td><?php echo $vals['checkout_time'];?></td>
                    <td> <div class="stra_hotel" data-star="<?=$vals['rating']?>">
                 ...
                 <td><img src="https://tripglobo.com/beta1/admin-panel/uploads/special_trip/<?=$vals['hotel_image'];?>" style="height:50px;width:px;" alt="No Image"></td>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-md-12">
                  <form action="<?php echo WEB_URL; ?>general/specialhotel_userDetail" method="post">
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        <div class="col-md-9 ad-btn col-md-offset-3">
                            <input id="flight_trip_id" type="hidden" name="bus_trip_id" class="form-control" value="<?php echo $vals['hotel_trip_id'];?>" required="required" placeholder="Enter Phone No.">
