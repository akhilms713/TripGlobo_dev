		...
		<div class="container cont_pad">
         ...
         <form method="post" action="voucher">
			<div class="col-md-12 fgt_secss">
             ...
             <table class="table">
                <tr>
                     <td style="text-align:left;"><a href="allbusTrip_details/<?= $fid;?>" style="font-weight: 600;font-family: 'Font Awesome 5 Pro';    color: #203f7c!important;font-size:14px;margin-right: 3px;"><?php echo $vals->from_location;?> To <?php echo $vals->to_location;?>
                    </a></td>	
