         ...
         <form method="post" action="voucher">
			<div class="col-md-12 fgt_secss">
			     ...
			     <!--	<table class="table">
			     	 ...
			     	 <?php
			     	    $i=1;
			     	       foreach($hotal_trip_details as $vals)
			     	       {
			     	       //debug($vals);exit();
			     	       $fid=base64_encode(json_encode($vals->hotel_trip_id));
			     	    ?>
			     	<div class="col-md-3">
             <table class="table">
                <tr>
                     <td style="text-align:left;"><a href="allhotelTrip_details/<?= $fid;?>" style="font-weight: 600;font-family: 'Font Awesome 5 Pro';    color: #203f7c!important;font-size:14px;margin-right: 3px;"><?php echo $vals->city_name;?> 
                    </a></td>	
