...
<section id="main-content" class="col-md-12 tab_sty nopad edit-prof">
  ...
  <i class="fal fa-user "></i> Contact Details</a></li>
   <li id="Flight">
    <a href="<?php echo WEB_URL; ?>dashboard/bookings/<?php echo base64_encode(json_encode('Flight')); ?>"><i class="fal fa-ticket"></i> Passport Information</a>
  </li>

   <li id="Hotel">
    <a href="<?php echo WEB_URL; ?>dashboard/bookings/<?php echo base64_encode(json_encode('Hotel')); ?>"><i class="fal fa-building"></i> Preferences</a>
  </li>
  </ul>
</div>
