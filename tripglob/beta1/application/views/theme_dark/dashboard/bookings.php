...
<div class="rowit" id="BookingList">
	<?php $flight_count=0; $hotel_count=0; $car_count=0; 
			$package_count=0; $activity_count=0; $rail_count = 0;
			$cruise_count=0; $transfer_count=0; $all_count = 0;
      // echo "<pre>";print_r($getoverallBookings);
                    ...
                    if($outward_departure_info < $current_datetime_info) {
                      ...
                      <tr class="">
                        ...
                        <?php if($result->pnr_no !='' && $result->booking_status == 'CONFIRMED') { ?>
                          ...
                          <!--<a href="<?php //echo WEB_URL; ?>voucher/<?php //echo base64_encode(base64_encode($result->pnr_no)); ?>"  class="btn send_voucher_email_btn" onclick="sendVoucherMail_flight('<?php echo $result->pnr_no; ?>')">SEND MAIL</a>-->
                ...
                <div class="booking_rows">
                  ...
                  <div class="inside_bookrow">
                    <div class="from_to_all">
                        ...
                        <?php } else { ?>
                        <div class="left_city"><?php echo $result->origin_city; ?><span class="fa fa-long-arrow-right"></span><?php echo $hoteldata->city; ?> </div><div class="travel_date"><?php echo date('M \. d Y', strtotime($result->check_in)).' - '.date('M \. d Y', strtotime($result->check_out)); ?></div>
                        <?php } ?>
        ...
        $csno = 1;
         if($car_count > 0){
           ...
           if($getoverallBookings[$k]->product_name == 'CAR'){
                         ...
                         $result = $this->account_model->getBookingbyPnr($getoverallBookings[$k]->parent_pnr_no,$getoverallBookings[$k]->product_name)->row();              
                         // debug(json_decode(base64_decode($result->segment_data), true)['car_pick_up_dt']);die;
