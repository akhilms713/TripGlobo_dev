...
<!--old profinfo -->
          ...
          <div role="tabpanel" class="tab-pane " id="profile">
            ...
            <input  name="depature" id="" required type="text" class="form-control date_edit_pass" value="<?php echo $userInfo->passport_expirydate; ?>" placeholder="Passport Expiry Date"  readonly="true"/>
              </div>
              <div class="col-lg-3 col-md-3 col-sm-12 fullprofiles">
 ...
 <!-- Deal Info -->
            ...
            <div class="tab-content deal-tabsscont ">
                      ...
                      foreach($promo_deal_list as $k=>$val){ 
                        ...
                        <div class="col-md-12 deal-outss">
                          <div class="col-md-7 deal-imgss">
                           <h5><span class="promo-label">Flight Deal <span><?=$val->discount?><?=($val->discount == "PERCENTAGE") ? " %" : " $"?> </span> Off </span></h5>
                      ...
                      foreach($promo_deal_list as $k=>$val){ 
                        ...
                        <div class="col-md-12 deal-outss">
                          <div class="col-md-7 deal-imgss">
                            ...
                            <img src="<?=base_url().'photo/users/'.$val->pic_name;?>" />
                          
                          </div>
                           <div class="col-md-5 deal-details">
                            <h5>Hotel Deal <span><?=$val->discount?><?=($val->discount == "PERCENTAGE") ? " %" : " $"?> </span> Off </h5>
                            <h4 class="deal-promooocode"><span class="promo-label">PROMO CODE</span> <span class="deal-promoo"><?=$val->promo_code?></span></h4>
              ...
              <div role="tabpanel" class="tab-pane" id="deal-car">
                <h3 class="lineth">Car Deals</h3>
                 <?php // print_r($promo_deal_list);
                      ...
                      foreach($promo_deal_list as $k=>$val){ 
                        ...
                        <div class="col-md-12 deal-outss">
                          <div class="col-md-7 deal-imgss">
                           ...
                           <div class="col-md-5 deal-details">
                            <h5>Car Deal <span><?=$val->discount?><?=($val->discount == "PERCENTAGE") ? " %" : " $"?> </span> Off </h5>
                            <h4 class="deal-promooocode"><span class="promo-label">PROMO CODE</span> <span class="deal-promoo"><?=$val->promo_code?></span></h4>
                            <h6>*Valid till <span><?=date('d M Y', strtotime($val->created_date))?></span> to <span><?=date('d M Y', strtotime($val->expiry_date))?></span> </h6>
                          </div>
                        </div>
