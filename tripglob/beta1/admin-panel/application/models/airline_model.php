...
// function get_airport_list_new($cityname){
//      $this->db("SELECT * FROM iata_airport_list where airport_code  like '%$cityname%'  or airport_name like '%$cityname%'");
     
// // 		$this->db->select('*');
// // 		$this->db->from('iata_airport_list');
// // 		$this->db->where('airport_code', $cityname);
// 		$query=$this->db->get();
// 		if($query->num_rows() ==''){
// 			return '';
// 		}else{
