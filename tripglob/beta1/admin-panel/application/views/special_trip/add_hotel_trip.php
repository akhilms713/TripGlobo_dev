                              ...
                              <form class="form-horizontal form-label-left" novalidate method="post"action="<?php echo WEB_URL; ?>special_trip/add_hotel_trip" enctype="multipart/form-data">
                                ...
                                <!-- <div class="item form-group">
                                      ...
                                      <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="image" type="file" name="image" class="form-control col-md-7 col-xs-12" required="required" placeholder="Image">
                                            </div>
                                        </div>
                                          <div class="item form-group">
                                            <label for="zip_code" class="control-label col-md-3 col-sm-3 col-xs-12">Rating</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="rating" type="text" name="rating" class="form-control col-md-7 col-xs-12" required="required" placeholder="Rating">
                                            </div>
                                        </div>
                                          <div class="item form-group">
                                            <label for="zip_code" class="control-label col-md-3 col-sm-3 col-xs-12">Address</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="address" type="text" name="address" class="form-control col-md-7 col-xs-12" required="required" placeholder="Address">
                                            </div>
                                        </div>
