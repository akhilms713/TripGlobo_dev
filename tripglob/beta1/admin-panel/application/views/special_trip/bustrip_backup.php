                                    ...
                                    <tbody>
                                        ...
                                        foreach($allData as $user)
                                        {
                                           ...
                                           <tr class="even pointer">
                                            ...
                                            <td class=""> <img width="50" title="<?php echo $user->trip_image; ?>" alt="<?php echo $user->trip_image; ?>" src="<?php echo WEB_FRONT_URL; ?>photo/users/<?php echo $user->trip_image; ?>">
                                            </td>
                                            <td class=""><?php echo $user->trip_offered_price; ?></td>
                                           <td class=""><?php echo $user->trip_start; ?></td>
                                           <td class=""><?php echo $user->trip_end; ?></td>
                                           <td class=""><?php echo $user->trip_status; ?></td>
                                           
                                           
                                            <td>
                                              <a href="<?php echo WEB_URL; ?>staff/view_profile/<?php echo $user->user_id; ?>" onclick="return confirm('Do You Want to See User Details ?')"> <i class="fa fa-th-list" title="View profile"></i></a>
                                              <a href="<?php echo WEB_URL; ?>staff/edit_profile/<?php echo $user->user_id; ?>"  onclick="return confirm('Do You Want to Edit Details ?')">   <i class="fa fa-pencil-square-o" title="Edit profile"></i></a>
