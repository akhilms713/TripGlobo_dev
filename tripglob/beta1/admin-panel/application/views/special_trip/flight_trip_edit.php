                              ...
                              <form class="form-horizontal form-label-left"  method="post" action="<?php echo WEB_URL; ?>special_trip/update_flight_trip/<?php echo $flight_details->flight_trip_id; ?>" enctype="multipart/form-data" enctype="multipart/form-data">
                                 ...
                                 <div class="item form-group">
                                   ...
                                   <span class="text-danger"><?php echo form_error('to'); ?></span>
                                    ...
                                    <label for="" class="control-label col-md-3 col-sm-3 col-xs-12">Departure Date</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                         <input id="single_cal6" type="text" name="departure_date[]"  class="form-control col-md-7 col-xs-12" value="<?php echo $departure_date1;?>" required="required" readonly>
                                         </div>
                                    </div>
                                    <div class="item form-group">
                                    <label for="Check-out" class="control-label col-md-3 col-sm-3 col-xs-12">Arrival Date</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="single_cal7" type="text" name="arrival_date[]"  class="form-control col-md-7 col-xs-12" value="<?php echo $arrival_date1;?>" required="required" readonly >
                                 ...
                                 <div class="item form-group">
                                   ...
                                   <span class="text-danger"><?php echo form_error('to'); ?></span>
                                    ...
                                    <label for="" class="control-label col-md-3 col-sm-3 col-xs-12">Departure Date</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                         <input id="single_cal8" type="text" name="departure_date[]"  class="form-control col-md-7 col-xs-12" value="<?php echo $departure_date2;?>" required="required" readonly>
                                         </div>
                                    </div>
                                    <div class="item form-group">
                                    <label for="Check-out" class="control-label col-md-3 col-sm-3 col-xs-12">Arrival Date</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="single_cal9" type="text" name="arrival_date[]"  class="form-control col-md-7 col-xs-12" value="<?php echo $arrival_date2;?>" required="required" readonly >
