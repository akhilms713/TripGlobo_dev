                                 ...
                                 <tbody>
                                    ...
                                    <tr class="even pointer">
                                       ...
                                       <td class="text-center">
                                          <a href="<?php echo WEB_URL; ?>news/update/<?php echo $row->id; ?>">  <i class="fa fa-pencil-square-o" title="Edit"></i></a>
                                          <a href="<?php echo WEB_URL; ?>news/delete/<?php echo $row->id; ?>" onclick="return confirm('Do You Want to delete this NEWS?')">  <i class="fa fa-times" title="Delete"></i></a>
                                       </td>
                                    </tr>
                                    <?php $i++; } } ?>
                                 </tbody>
