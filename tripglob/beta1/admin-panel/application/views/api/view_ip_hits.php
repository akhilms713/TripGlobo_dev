                                     ...
                                     <tbody>
                                        ...
                                        foreach($ip_details as $ip)
                                        {
                                           ...
                                           <tr class="even pointer">
                                            ...
                                            <td class=""><?php echo $ip->api_name; ?></td>
                                            <td class=""><?php echo $ip->xml_status; ?></td>
                                            <td class=""><?php echo $ip->ip_address; ?></td>
                                            <td class=""><?php echo $ip->xml_timestamp; ?></td>
                                            <td>
                                           <a class='btn btn-inverse btn-xs'  data-toggle="tooltip" data-placement="top" title="" data-original-title='See the xml request' href='<?php echo WEB_URL; ?>api/export_xml_log_request/<?php echo $ip->xml_logs_id; ?>' role='button'>
                                                                                        <i class='fa fa-search'></i>
                                                                              </a>
                                        <a class='btn btn-inverse btn-xs'  data-toggle="tooltip" data-placement="top" title="" data-original-title='See the xml response' href='<?php echo WEB_URL; ?>api/export_xml_log_response/<?php echo $ip->xml_logs_id; ?>' role='button'>
                                                                                        <i class='fa fa-search'></i>
                                                                              </a> 
                                                                               </td>
