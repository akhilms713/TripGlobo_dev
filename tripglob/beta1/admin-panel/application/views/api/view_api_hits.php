                                ...
                                <table id="example" class="table table-striped responsive-utilities jambo_table">
                                    <thead>
                                     ...
                                     <tbody>
                                        <?php 
										$i=1;
										if(!empty($api_name_details))
										{
                                        foreach($api_name_details as $api)
                                        {
                                           ...
                                           <tr class="even pointer">
                                            ...
                                            <td class=""><?php echo $api->TOTAL_HITS; ?></td>
                                            <td class=""><?php echo $api->ip_address; ?></td>
                                            <td>
                                           <a href="<?php echo WEB_URL; ?>api/view_ip_hits/<?php echo ($this->uri->segment(3)) ? $this->uri->segment(3) : 0; ?>/<?php echo $api->ip_address; ?>"> <i class="fa fa-search" title="View"></i></a>
                                            </td>

                                        </tr>
                                        <?php
                                    }//hi pramod              fyp please let me know if you further details
										}
                                    ?>
                                </tbody>
