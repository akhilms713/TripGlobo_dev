						...
						<div class="panel-body">							
							<form method="post" action="<?php echo site_url()."markup/add_air_coun_dest_markup"; ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">				
								<div class="form-group">
									...
									<div class="col-sm-5">
										<select name="user_type" class="select2 form-control" required onchange="chaeck_user(this.value)">
								...
								<div class="form-group" id="source">
									...
									<div class="col-sm-5">
										<input type="text" required name="from_city" id="from_city" class="form-control ft fromflight ui-autocomplete-input f_book_box1" onclick="this.select();" placeholder="City_or_Airport" autocomplete="off">
									</div>
								</div>	
								...
								<div class="form-group" id="destination">
									...
									<div class="col-sm-5">
										<input type="text" required name="to_city" id="to_city" class="form-control ft  ui-autocomplete-input f_book_box1" onclick="this.select();" placeholder="City_or_Airport" autocomplete="off">
									</div>
								</div>
								...
								<div class="form-group">
									<label for="field-1" class="col-sm-3 control-label">Markup Type</label>									
									<div class="col-sm-5">
										<select  name="markup_value_type" class="select2 form-control" required onchange="change_val(this.value)">
