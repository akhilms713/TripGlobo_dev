							...
							<form method="post" action="<?php echo site_url()."markup/add_markup"; ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">				
								...
								<div id="percent">
									<div class="form-group">
										...
										<div class="col-sm-5">
											<input type="text" class="form-control" id="field-mv" name="markup_value" placeholder="Markup Value" data-validate="required" data-message-required="Please enter the Markup Value" autocomplete="off">
										</div>
									</div>
								</div>
								<div id="fixed">
