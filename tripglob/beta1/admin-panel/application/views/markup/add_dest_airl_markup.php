						...
						<div class="panel-body">							
							<form method="post" action="<?php echo site_url()."markup/add_dest_air_markup"; ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">				
								<div class="form-group">
									...
									<div class="col-sm-5">
										<select name="user_type" class="select2 field_grp_1" required onchange="chaeck_user(this.value)">
								...
								<div id="agent_list">
									<div class="form-group">
										...
										<div class="col-sm-5">
											<select name="agent_name" class="select2 field_grp_1">
											<option value="All">Select User</option>
											<?php for ($i=0; $i < count($agents); $i++) { ?>
											<option value="<?php echo $agents[$i]->user_id;?>"><?php echo $agents[$i]->user_name.'-'.$agents[$i]->user_email;?></option>;
											<?php } ?>
											</select>
										</div>
									</div>
								...
								<div class="form-group hide">
									...
									<div class="col-sm-5">
										<select name="domain" class="select2 field_grp_1" required>
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<select name="product" id="product" class="select2 field_grp_1" required>
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<select name="api" class="select2 field_grp_1" required>
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<select onchange="makup_type_details(this.value)" id="markup_type" name="markup_type" class="select2 field_grp_1" required>
								...
								<div class="form-group" id="airline">
									...
									<div class="col-sm-5">
										<select name="airline"  class="select2 field_grp_1" required>
								...
								<div class="form-group" id="trip">
									...
									<div class="col-sm-5">
										<select name="trip_type" onchange="trip_type_change(this.value)"  class="select2 trip_type field_grp_1" required>
...
<div class="form-group" id="source">
								...
								<div class="form-group">
									<label for="field-1" class="col-sm-3 control-label">Markup Type</label>									
									<div class="col-sm-5">
										<select  name="markup_value_type" class="select2 field_grp_1"  onchange="change_val(this.value)" required>
								...
								<div id="percent">
									<div class="form-group">
										...
										<div class="col-sm-5">
											<input type="text" class="form-control" id="field-ms" name="markup_value" placeholder="Markup Value" data-validate="required" data-message-required="Please enter the Markup Value" autocomplete="off"required>
										</div>
									</div>
								</div>
								<div id="fixed">
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" id="field-mf" name="markup_fixed" placeholder="Markup Fixed" data-validate="required" data-message-required="Please enter the Markup Fixed" required>
									</div>
								</div>
								</div>
								<!-- <div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<button id="hide" type="submit" class="btn btn-success">Add Markup Details</button>
									</div>
								</div>
							</form>
						</div>
