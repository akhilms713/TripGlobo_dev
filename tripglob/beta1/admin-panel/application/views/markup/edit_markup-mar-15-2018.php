							...
							<form method="post" action="<?php echo site_url()."markup/update_markup/".base64_encode(json_encode($markup[0]->markup_details_id)); ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">				
								...
								<div id="percent">
									<div class="form-group">
										...
										<div class="col-sm-5">
											<input type="text" class="form-control" id="field-mv" name="markup_value" value="<?php echo $markup[0]->markup_value; ?>" data-validate="required" data-message-required="Please enter the Markup Value" autocomplete="off">
										</div>
									</div>
								</div>
								<div id="fixed">
