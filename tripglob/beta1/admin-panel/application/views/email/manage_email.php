                                     ...
                                     <tbody>
                                        ...
                                        foreach($emails as $email)
                                        {
                                           ...
                                           <tr class="even pointer">
                                             ...
                                             <td class=""><?php echo $email->email_type; ?></td>
                                             <td class=""><?php echo $email->subject; ?></td>
                                             <td class=""><?php echo $email->email_from; ?></td>
                                             <td class=""><?php echo $email->email_from_name; ?></td>
                                            
                                             <td>
                                            <!-- EB - Email Boady -->
                                            <textarea hidden id="EB_<?php echo $email->email_template_id; ?>"><?php echo $email->message; ?></textarea> 
                                         
                                            <a href="<?php echo WEB_URL; ?>email/edit_email_template/<?php echo $email->email_template_id  ; ?>" onclick="return confirm('Do You Want to Edit this Email Template Details ?')">
