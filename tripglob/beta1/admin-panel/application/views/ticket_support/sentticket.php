            ...
            <div class="right_col" role="main">
                ...
                <div class="">
                  ...
                  Sent Ticket
                    ...
                    <h4><a href="<?php echo WEB_URL; ?>ticket_support/sent/"><button class="btn btn-sm" style="float:right;">All Tickets</button></a></h4>
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="row">
                                     <?php if($sentticket){ ?>
                                       ...
                                       <?php $count = 0; foreach($sentticket as $allinbox){
                                       //echo "<pre/>";print_r($allinbox);exit();
                                        ...
                                        <div class="col-sm-8 mail_view singleticketdisplay" >
                                            <div class="inbox-body">
                                                <div class="mail_heading row">
                                                    ...
                                                    <div class="col-md-12">
                                                    <span class="ticket_time"> <?php $date = date_create($sentsingleticket->last_update_time); if(date_format($date, 'Y-m-d') == date("Y-m-d")) { echo date_format($date, 'g:ia'); } else{ echo date_format($date, 'g:ia j M Y');  } ?></span>
                                                        <h4> <?php echo $sentsingleticket->support_ticket_subject_value; ?></h4>
                                                    </div>
                                                </div>
                                               <div class="sender-info">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <strong><?php echo $sentsingleticket->user_name; ?></strong>
                                                            <span>(<?php echo $sentsingleticket->user_email; ?>)</span> to
                                                            <strong>admin</strong>
                                                ...
                                                <div class="view-mail">
                                                    <p><?php echo $sentsingleticket->message; ?></p>
                                                </div>
                                                <?php if($sentsingleticket->file_path){  ?>
                                                <div class="attachment">
                                                    <p>
                                                        <span><i class="fa fa-paperclip"></i> 1 attachment — </span>
                                                        <a href="<?php echo $sentsingleticket->file_path; ?>" download>Download all attachments</a> |
                                                        <a href="#">View</a>
                                                    </p>
                                                </div><?php } ?>
                                                </div>
                                           <div class="col-md-12 nopad"> <b>Replies:</b>
                                    <?php if($senttickethistory) foreach($senttickethistory as $history){  ?><div class="ticket_content ticket_<?php echo $history->support_ticket_history_id; ?>"><div class="left">
                                    ...
                                    <p><?php echo $history->message; ?></p>
                                     ...
                                     ?><p class="new_replys"></p>
                                            ...
                                            <div class="compose-btn pull-left">
                                                   ...
                                                   <a href="<?php echo WEB_URL; ?>ticket_support/closeTicket/<?php echo $sentsingleticket->support_ticket_id; ?>"> <button title="" data-placement="top" data-toggle="tooltip" data-original-title="Close Ticket" class="btn btn-sm tooltips"><i class="fa fa-trash-o"></i></button></a>
                                                    </button>
                                            </div>
                                            <div class="col-md-12 reply_rext_area">
                                                        <div id="summernote"><p>Enter Your Reply...</p></div> 
                                            <form method="post" action="" enctype="multipart/form-data"  id="upload_file" >
                                                    
                                                            <input type="file" name="userfile" id="userfile" size="20" />
                                                            <input type="submit" class="btn btn-info ticket_reply" alt="<?php echo $sentsingleticket->support_ticket_id; ?>" name="submit" value="Send" id="submit" />
                                            </form>
