                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Add New Advertisement  <small> </small></h2>
                                    
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">

                                    <form class="form-horizontal form-label-left" novalidate method="post" action="<?php echo WEB_URL; ?>adevertise/add_new_adevertise_do" enctype="multipart/form-data">
                                        ...
                                        <!-- <div class="item form-group">
                                          ...
                                          <div class="col-md-6 col-sm-6 col-xs-12">                    
                                            <select name="adevertise_type" class="form-control col-md-7 col-xs-12">
                                              <option value="INTERNAL" data-iconurl="" >INTERNAL</option>
                                              <option value="EXTERNAL" data-iconurl="" >EXTERNAL</option>                                              
                                            </select>
                                          </div>
                                        </div> -->
                                         ...
                                         <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="add_title" type="url" name="add_title"   class="form-control col-md-7 col-xs-12" required="required">
                                            </div>
                                        </div>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="adv_amount" type="number" name="adv_amount"   class="form-control col-md-7 col-xs-12" required="required">
                                            </div>
                                        </div>
                                        
                                            
                                          <div class="item form-group">
                                            <label for="Adevertise_image" class="control-label col-md-3">Advertisement Image</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                 <input id="Adevertise_image" type="file" name="Adevertise_image" class="ft fromflight form-control col-md-7 col-xs-12" value="" required="required">
                                            </div>
                                        </div>
