                             ...
                             <?php } ?>
                              <form class="form-horizontal form-label-left input_mask" novalidate method="post" action="" enctype="multipart/form-data">
                                 <div class="item form-group">
                                    <label for="message" class="control-label col-md-3 col-sm-3 col-xs-12">Class Name</label>
                                    <div class="col-md-9 col-sm-6 col-xs-12">
                                       <input type="text" name="class_name" required="required" id="class_name"  class="form-control" />
                                    </div>
                                 </div>
      ...
      var api_url='<?php echo WEB_FRONT_URL; ?>';
        $(function() {
          $(".airlineName").autocomplete({
             source: api_url+"general/get_airline_suggestions",
