                                     ...
                                     <tbody>
                                        ...
                                        foreach($result as $bookings)
                                        {
                                           ...
                                           <tr class="even pointer">
                                            ...
                                            <td class=""><?php echo $bookings['con_pnr_no']; ?> </td>
                                            <td class=""><?php echo $bookings['parent_pnr_no']; ?></td>
                                            <td class=""><?php echo $bookings['leadpax']; ?></td>
                                            <td class=""><?php echo date('Y-m-d',strtotime($bookings['voucher_date'])) ?></td>
                                            <td class=""><?php echo  date('Y-m-d',strtotime($bookings['travel_date'])); ?></td>
