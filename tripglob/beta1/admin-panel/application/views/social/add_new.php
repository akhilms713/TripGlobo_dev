                   ...
                   Social Link
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Add New Social Link <small> </small></h2>
                                    
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">

                                    <form class="form-horizontal form-label-left" novalidate method="post" action="<?php echo WEB_URL; ?>social/add_new_sociallink_do" enctype="multipart/form-data">
                                          ...
                                          <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                 <input id="social_link_name" type="text" name="social_link_name" class="ft fromflight form-control col-md-7 col-xs-12" value="" required="required">
                                            </div>
                                        </div>
                                         <div class="item form-group">
                                            <label for="social_link" class="control-label col-md-3">Social Link</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="link" type="url" name="social_link"  class="form-control col-md-7 col-xs-12" required="required">
                                            </div>
                                        </div>
                                         ...
                                         <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="icon" type="text" name="social_icon"  class="form-control col-md-7 col-xs-12" required="required">
                                            </div>
                                        </div>
