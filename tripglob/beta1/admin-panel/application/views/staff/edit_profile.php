          ...
          <?php echo $this->load->view('common/top_menu'); ?>
            ...
            <div class="right_col" role="main">
              ...
              <?php }elseif($status=='0'){?>
               ...
               <?php } ?><form class="form-horizontal form-label-left input_mask" novalidate method="post" action="<?php echo WEB_URL; ?>staff/edit_profile_do/<?php echo $user->user_id; ?>" enctype="multipart/form-data">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="aadhar_card" name="aadhar_card" value="<?php echo $user->aadhar_card; ?>" type="text" class="form-control" required="required" placeholder="Aadhar Card">
                            </div>
                        </div>
						  <div class="item form-group">
                        ...
                        <div class="item form-group">
                                            ...
                                            <div class="col-md-3 col-sm-6 col-xs-12">
                                                ...
                                                <img src="<?=WEB_FRONT_URL.'photo/users/'.$user->profile_picture; ?>" width="150" height="100">
                                              <!-- <img src="<?php //echo WEB_URL.'uploads/users/'.$admin->admin_profile_pic ?>" width="150" height="100">-->
                                            </div>
                                            <div class="col-md-3 col-sm-6 col-xs-12">
                                               <input  type="file" name="profile_photo" id="profile_photo" class="form-control col-md-7 col-xs-12" accept="image/*">
                                            </div>
                                         </div>
