                                ...
                                <table id="example" class="table table-striped responsive-utilities jambo_table">
                                    ...
                                    <tbody>
                                        ...
                                        { ?>
                                          ...
                                          <a href="<?php echo WEB_URL; ?>topairliners/edit_topairline/<?php echo $airline['airline_list_id']; ?>">  <i class="fa fa-pencil-square-o" title="Edit TopAirliners"></i></a>
                                            <a href="<?php echo WEB_URL; ?>topairliners/delete_topairlines/<?php echo $airline['airline_list_id']; ?>">  <i class="fa fa-times" title="Delete TopAirlines"></i></a>
...
$('.whiteip1').on('click', function() {
		...
		if(_id1  > 0 ) {
			...
			$.ajax({
				url: '<?php echo WEB_URL; ?>topairliners/update_topairline_status',
				type: "get",
