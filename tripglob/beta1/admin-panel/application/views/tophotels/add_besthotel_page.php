                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Add New Best Hotel <small> </small></h2>
                                    
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">

                                    <form class="form-horizontal form-label-left" novalidate method="post" action="<?php echo WEB_URL; ?>tophotels/add_besthotels_do" enctype="multipart/form-data">
                                       ...
                                       <!--  <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                               <input  name="depature" id="depature"  type="text" class="ft  form-control col-md-7 col-xs-12 forminput date_picker"  value="" placeholder="checkin Date" readonly required="required"/>
                                       ...
                                       <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                              <input type="text" name="return" id="return"  class="ft  form-control col-md-7 col-xs-12 forminput date_picker" value="" placeholder="Checkout Date" readonly required="required" />
                                        ...
                                        <div class="form-group">   
                                            <div class="col-md-3 col-md-offset-3">
                                              ...
                                              <a href="javascript:history.back()"  class="btn btn-primary ad-cancel">Cancel</a>                                                
                                                <button id="send" type="submit" id="submit" class="btn btn-success">Save</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
...
// room adding for hotel
 // initialize the validator function
        ...
        $('form').submit(function (e) {
          var imgVal = $('#hotel_image').val(); 
            if(imgVal=='') 
            { 
                $("#imgval").html("Please put the image");
                return false;
...
<script type="text/javascript">
  var test="<?php echo $this->session->flashdata('img_msg'); ?>";
  if(test!=''){
    alert('<?php echo $this->session->flashdata('img_msg'); ?>');
  }
</script>
