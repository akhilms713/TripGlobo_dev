                                ...
                                <table id="example" class="table table-striped responsive-utilities jambo_table">
                                    ...
                                    <tbody>
                                        ...
                                        { ?>
                                          ...
                                          <a href="<?php echo WEB_URL; ?>tophotels/edit_tophotel/<?php echo $hotel->last_minute_deals_id; ?>">  <i class="fa fa-pencil-square-o" title="Edit Tophotels"></i></a>
                                            <a onclick="return confirm('Are you sure you want to delete ?');" href="<?php echo WEB_URL; ?>tophotels/delete_tophotel/<?php echo $hotel->last_minute_deals_id; ?>">  <i class="fa fa-times" title="Delete Tophotels"></i></a>
...
$('.whiteip1').on('click', function() {
	...
	else
	{
		...
		if(_id1.toString().length > 0 && !isNaN(_id1)) {
			...
			$.ajax({
				url: '<?php echo WEB_URL; ?>tophotels/update_tophotel_status',
				type: "get",
