                                ...
                                <table id="example" class="table table-striped responsive-utilities jambo_table">
                                    <thead>
                                     ...
                                     <tbody>
										...
										if(!empty($xml_logs))
										{
                                        foreach($xml_logs as $logs)
                                        {
                                        
                                           ?>
                                           <tr class="even pointer">
                                             <td class=" "><?php echo $i++; ?></td>
                                            <td class=""><?php echo $logs->api_name;?></td>
                                            <td class=""><?php echo $logs->xml_type;?></td>
                                            <td class=""><?php echo $logs->ip_address;?></td>
                                             <td class=""><?php echo $logs->xml_timestamp;?></td>
                                            <td class="">
                                            <?php echo $logs->xml_status; ?>
                                              </td>
                                          <td>
                                            <a class='btn btn-inverse btn-xs'  data-toggle="tooltip" data-placement="top" title="" data-original-title='See the xml request' href='<?php echo WEB_URL; ?>xml_logs/export_xml_log_request/<?php echo $logs->xml_logs_id; ?>' role='button'>
                                                                                        <i class='fa fa-search'></i>
                                                                              </a>
                                        <a class='btn btn-inverse btn-xs'  data-toggle="tooltip" data-placement="top" title="" data-original-title='See the xml response' href='<?php echo WEB_URL; ?>xml_logs/export_xml_log_response/<?php echo $logs->xml_logs_id; ?>' role='button'>
                                                                                        <i class='fa fa-search'></i>
                                                                              </a> 
                                            </td>
