                                           ...
                                           <tr class="even pointer">
                                            ...
                                            <td class=""><?php echo $booking_logs[$j]->supplier_timestamp; ?></td>
                                              ...
                                              <td class=" last">
                                                ...
                                                <a class='btn btn-inverse btn-xs ' data-toggle="tooltip" data-placement="top" title="" data-original-title='See the Prebook xml request' href='<?php echo WEB_URL; ?><?php echo $booking_logs[$j]->prebook_xml_request; ?>' role='button' download>
                                                                                        <i class='fa fa-search'></i>
                                                                              </a>
                                                <a class='btn btn-inverse btn-xs 'data-toggle="tooltip" data-placement="top" title="" data-original-title='See the Prebook xml response' href='<?php echo WEB_URL; ?><?php echo $booking_logs[$j]->prebook_xml_response; ?>' role='button' download>
                                                                                        <i class='fa fa-search'></i>
                                                                              </a> 
                                                <a class='btn btn-inverse btn-xs' data-toggle="tooltip" data-placement="top" title="" data-original-title='See the Process Terms Request' href='<?php echo WEB_URL; ?><?php echo $booking_logs[$j]->ProcessTermsRequest; ?>' role='button' download>
                                                                                        <i class='fa fa-search'></i>
                                                                              </a> 
                                                <a class='btn btn-inverse btn-xs' data-toggle="tooltip" data-placement="top" title="" data-original-title='See the Process Terms Response' href='<?php echo WEB_URL; ?><?php echo $booking_logs[$j]->ProcessTermsResponse; ?>' role='button' download>
                                                                                        <i class='fa fa-search'></i>
                                                                              </a> 
                                                <a class='btn btn-inverse btn-xs' data-toggle="tooltip" data-placement="top" title="" data-original-title='See the Start Booking Flight Request' href='<?php echo WEB_URL; ?><?php echo $booking_logs[$j]->StartBookingFlightRequest; ?>' role='button' download>
                                                                                        <i class='fa fa-search'></i>
                                                                              </a>
                                                <a class='btn btn-inverse btn-xs' data-toggle="tooltip" data-placement="top" title="" data-original-title='See the Start Booking Flight Response' href='<?php echo WEB_URL; ?><?php echo $booking_logs[$j]->StartBookingFlightResponse; ?>' role='button' download>
                                                                                        <i class='fa fa-search'></i>
                                                                                        </a>
                                                <a class='btn btn-inverse btn-xs' data-toggle="tooltip" data-placement="top" title="" data-original-title='See the Check Booking Flight Request' href='<?php echo WEB_URL; ?><?php echo $booking_logs[$j]->CheckBookingFlightRequest; ?>' role='button' download>
                                                                                        <i class='fa fa-search'></i>
                                                                                                        </a> 
                                                <a class='btn btn-inverse btn-xs' data-toggle="tooltip" data-placement="top" title="" data-original-title='See the Check Booking Flight Response' href='<?php echo WEB_URL; ?><?php echo $booking_logs[$j]->CheckBookingFlightResponse; ?>' role='button' download>
                                                                                        <i class='fa fa-search'></i>
                                                                                                        </a>                                                                                          
                                              </td>
                                        </tr>
