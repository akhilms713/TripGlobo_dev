                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="dashboard_graph">
                            ...
                            <div class="row x_title">
                                <div class="col-md-6">
                                    <h3>Product Booking Graph<small></small></h3>
                                </div>
                                <div class="col-md-6">
                                    <div id="daterangepic" class="pull-right" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 new_graph">
