                ...
                <table class="table table-striped responsive-utilities jambo_table" id="flight_report_pre">
                 <thead>
                  ...
                  <tbody> 
                    <?php if($group_report){  
                        $num = 1; 
                        for($k=0;$k<count($group_report);$k++){ 
                        $admin_id=$group_report[$k]['admin_id'];
                      ...
                      <tr class="">
                        ...
                        <td><?php echo $a_name; ?></td>
                         <td><?php echo $group_report[$k]['remarks']; ?></td>
                        <td><?php echo date('d M Y, h:i A',strtotime($group_report[$k]['date'])); ?></td>
