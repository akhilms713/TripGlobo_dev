...
<head>
	...
	<link href="http://provabtechnosoft.net/assets/css/common/toggle-switch.css" rel="stylesheet" media="screen">
                                ...
                                <table id="example" class="table table-striped responsive-utilities jambo_table">
                                    <thead>
                                     ...
                                     <tbody>
										...
										if(!empty($city_basis))
										{
                                        foreach($city_basis as $bookings)
                                        {
                                        
                                           ?>
                                           <tr class="even pointer">
                                             <td class=" "><?php echo $i++; ?></td>
                                            <td class=""><?php echo $bookings->city; ?> </td>
