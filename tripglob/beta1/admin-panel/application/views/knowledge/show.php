                                 ...
                                 <tbody>
                                    ...
                                    <tr class="even pointer">
                                       ...
                                       <td class="text-center">
                                          <a href="<?php echo WEB_URL; ?>knowledge/update/<?php echo $row->id; ?>" onclick="return confirm('Do You Want to Edit this Knowledge?')">  <i class="fa fa-pencil-square-o" title="Edit"></i></a>
                                          <a href="<?php echo WEB_URL; ?>knowledge/delete/<?php echo $row->id; ?>" onclick="return confirm('Do You Want to Delete this Knowledge?')">  <i class="fa fa-times" title="Delete"></i></a>
                                       </td>
                                    </tr>
                                    <?php $i++; } } ?>
                                 </tbody>
        ...
        buttons: [
            {
                ...
                customize: function (doc) {
                    ...
                    // doc.pageOrientation = 'landscape'; // or 'portrait'
         ...
         $('.whiteip1').on('click', function() {
             ...
             else
             {
                 ...
                 if(_id1.toString().length > 0 && !isNaN(_id1)) {
                     ...
                     $.ajax({
                         url: '<?php echo WEB_URL; ?>knowledge/change_status/',
                         type: "get",
