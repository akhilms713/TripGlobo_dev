<?php
   //echo "<pre>"; print_r($airline_list); echo "</pre>"; die();
                  ...
                  <div class="row">
                     <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                           <div class="x_content">
                               <!-- Search form (start) -->
                               <form method='post' action="<?= base_url() ?>airline_management/index/" class="pull-right" style="margin-bottom: -20px;">
                                    ...
                                    <tr class="even pointer">
                                       ...
                                       <td>
                                          ...
                                          <input  class="whiteip1" id="whiteip1_<?php echo $airline->airline_list_id; ?>" data-alert_id1="<?php echo $airline->airline_list_id; ?>" type="checkbox"  <?php if($airline->status != 0){?> checked="checked" <?php } ?> />
                                              <span class="htspan"> 
                                                <?php if($airline->status != '0'){?>
                                                    <span style="color: #0a0a0a;">Active</span>
                                                <?php }else { ?>
                                                    <span>Inactive</span>
                                                <?php } ?>
                                                </span>
                                          <a><img id="whiteip_load1<?php echo $airline->airline_list_id; ?>"  width="26"  style="display: none;"  src="<?php echo ASSETS.'/images/loader1.gif'; ?>"></a>
                                          </label>
                                       </td>
                                       <td>
                                          <a href="<?php echo WEB_URL; ?>airline_management/update_airline/<?php echo $airline->airline_list_id; ?>" onclick="return confirm('Do You Want to Edit this Airline Details ?')">  <i class="fa fa-pencil-square-o" title="Edit Airline Page"></i></a>
                                          <a href="<?php echo WEB_URL; ?>airline_management/delete_airline/<?php echo $airline->airline_list_id; ?>" onclick="return confirm('Do You Want to delete this Airline Details?')">  <i class="fa fa-times" title="Delete"></i></a>
                                       </td>
                                    </tr>
                                    <?php $i++; } } ?>
                                 </tbody>
...
<script>
   $(document).ready(function() {
       $('#example_info').text("Showing 1 to 30 of 10 entries")
    $('#example').DataTable( {
        dom: 'Bfrtip',
        "paging": false,
        "info": false,
         ...
         $('.whiteip1').on('click', function() {
             ...
             else
             {
                 ...
                 if(_id1.toString().length > 0 && !isNaN(_id1)) {
                     ...
                     $.ajax({
                         url: '<?php echo WEB_URL; ?>airline_management/update_airline_status/',
                         type: "get",
