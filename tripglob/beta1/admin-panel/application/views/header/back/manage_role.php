                    ...
                    <div class="">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2><?php echo $admin_role[0]->admin_role_name; ?><small> </small></h2>

                                        <div class="clearfix"></div>
                                    </div>
                                    <div class="x_content">
                                       <form class="form-horizontal form-label-left" novalidate method="post" action="<?php echo WEB_URL; ?>subadmin/activate_privilege">
                                        ...
                                        <div class="item form-group">
                                          <?php 
                                             // echo $value->privilege_name;
                                                 $checked = "";
                                                if(count($privileges_ids) > 0){
                                                    if (in_array($value->privilege_id, $privileges_ids)) {
                                                        $checked = 'checked="checked"';
                                                    }
                                                }
                                                echo '<input type="hidden" name="admin_role_id" value="'.$admin_role[0]->admin_role_id.'">';
                                                echo '<input type="checkbox" name="privilege[]" '.$checked.' value="'.$value->privilege_id.'" class="flat" />&nbsp;&nbsp;'.$value->privilege_name;
                                                echo " </div>";
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-md-offset-3">
                                            ...
                                            <a href="<?php echo WEB_URL ?>subadmin/role"  class="btn btn-primary">Cancel</a>                                                
