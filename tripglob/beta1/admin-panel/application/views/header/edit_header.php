                   ...
                   Header Menu
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Edit  Header Menu <small> </small></h2>
                                    
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">

                                    <form class="form-horizontal form-label-left" novalidate method="post" action="<?php echo WEB_URL."header/update_header/".base64_encode(json_encode($header_list[0]->header_details_id)); ?>">
                                          ...
                                          <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                 <input id="from" type="text" name="menu_name" value="<?php echo $header_list[0]->menu_name; ?>" class="ft fromflight form-control col-md-7 col-xs-12" value="" required="required">
                                            </div>
                                        </div>
                                         <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <option value="INTERNAL" <?php if($header_list[0]->menu_type == "INTERNAL"){ ?> selected <?php } ?> >INTERNAL</option>
                                                <option value="EXTERNAL" <?php if($header_list[0]->menu_type == "EXTERNAL"){ ?> selected <?php } ?> >EXTERNAL</option>
                                              </select>
                                            </div>
                                        </div>
                                         <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="menu_url" type="text" name="menu_url"  value="<?php echo $header_list[0]->menu_url; ?>" class="form-control col-md-7 col-xs-12" required="required">
                                            </div>
                                        </div>
                                         <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <option value="0" <?php if($header_list[0]->menu_level == "0"){ ?> selected <?php } ?> >0</option>
                                                <option value="1" <?php if($header_list[0]->menu_level == "1"){ ?> selected <?php } ?> >1</option>
                                              </select>
                                            </div>
                                        </div>
                                         <div class="item form-group">
                                            <label for="Special Desc" class="control-label col-md-3">Menu Position</label>
                                                 <div class="col-md-6 col-sm-6 col-xs-12">                                              
                                                 <input id="Menu Position" type="text" name="position"   value="<?php echo $header_list[0]->position; ?>"  class="form-control col-md-7 col-xs-12" required="required">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">                                                
                                                ...
                                                <option value="ACTIVE" <?php if($header_list[0]->menu_status == "ACTIVE"){ ?> selected <?php } ?> >ACTIVE</option>
                                                <option value="INACTIVE" <?php if($header_list[0]->menu_status == "INACTIVE"){ ?> selected <?php } ?> >INACTIVE </option>
                                              </select>
                                            </div>
                                        </div>                                     
