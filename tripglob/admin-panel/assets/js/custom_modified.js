   ...
   /* flight */  
     ...
     $(".fromflight").autocomplete({
       source: WEB_URL+"home/get_flight_suggestions",
  ...
  /*end*/
   function addFlights_old(){ 
     ...
     if(mymvaluexx==""){ 
       ...
       $("#rowsFlight").append('<div class="appenddiv"><div class="col-md-9 nopad"><div class="col-md-6 pad10 fullwidth_tab"><div class="marginbotom10"><div class="relativemask"> <span class="maskimg mfrom"></span><input type="text" class="ft fromflightm" data-refid ='+id+' id="from_m_'+id+'" name="from_m[]" placeholder="From, Airport Name or Airport City" /></div></div></div><div class="col-md-6 pad10 fullwidth_tab"><div class="marginbotom10"><div class="relativemask"> <span class="maskimg mto"></span><input type="text" class="ft departflightm" name="to_m[]"  data-refid ='+id+' id="to_m_'+id+'" placeholder="To, Airport Name or Airport City" /></div></div></div></div><div class="col-md-4 nopad fullwidth_tab"><div class="marginbotom10"><div class="col-xs-8 fiveh pad10"><div class="relativemask"> <span class="maskimg caln"></span><input  name="depature_m[]" id="departure_multi'+id+'" type="text" class="forminput date_picker" placeholder="'+dipatureDate+'" /></div></div><div class="col-xs-4 fiveh pad10"><div class="flightDate" id="addclose"><div><img src="'+WEB_URL+'assets/theme_dark/images/minus-button.png" id="closeflights" onclick="closeFlights()" style="cursor:pointer;" /></div></div></div></div></div></div>');
     ...
     $('#check-in, #check-out').on('change', function(e) {
      ...
      $("#flight").submit(function(e){
        ...
        if(total_pax_count>=9){
          ...
          $('#searchflight_error').html('Travelers should be less than 9');
