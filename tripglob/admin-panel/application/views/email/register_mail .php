                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="font-family: Arial, Helvetica, sans-serif; line-height: 20px; font-size: 13px; color: #676767; padding-left: 16px; padding-right: 16px;">
                                                        <span style="font-family: Arial, Helvetica, sans-serif; color: #0f1858; font-size: 14px;"><?php echo str_replace('{%%EMAILID%%}',$user_data->user_email, str_replace('{%%USERNAME%%}',$user_name ,$data['content']->header_content)); ?> </span><br>                                                        
                                               ...
                                               <?php    }elseif (!empty($data['content']->table_content)) {                  
