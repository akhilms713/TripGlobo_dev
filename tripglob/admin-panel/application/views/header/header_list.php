                                ...
                                <table id="example" class="table table-striped responsive-utilities jambo_table">
									...
									<?php if($header_list!=''){ for($a=0;$a<count($header_list);$a++){ ?>
                                           <tr class="even pointer">
                                                    ...
                                                    <td><?php echo ($a+1); ?></td>
                                                    <td><?php echo $header_list[$a]->menu_name; ?></td>
                                                    <td><?php echo $header_list[$a]->menu_type; ?></td>
                                                    <td><?php echo $header_list[$a]->menu_url; ?></td>
                                                    <td><?php echo $header_list[$a]->menu_level; ?></td>
                                                    <td><?php echo $header_list[$a]->position; ?></td>
                                                    <td>
                                                    <?php if($header_list[$a]->menu_status == "ACTIVE"){ ?>
