<?php
   // echo "<pre>"; print_r($flight_deal); echo "</pre>"; die();
                  ...
                  <div class="row">
                     <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                           ...
                           <div class="x_content">
                              <form class="form-horizontal form-label-left" novalidate method="post" action="<?php echo WEB_URL; ?>flight_deals/edit_flightdeal/<?php echo  $flight_deal['0']->flight_deal_id;  ?>" enctype="multipart/form-data">
                                 <input type="hidden" name="fdeal_id" value="<?php echo  $flight_deal['0']->flight_deal_id;  ?>" >
                                 <input type="hidden" name="old_image" value="<?php echo  $flight_deal['0']->deal_image;  ?>" >
                                 <input type="hidden" name="status" value="<?php echo  $flight_deal['0']->deal_status;  ?>" >
                                 <div class="item form-group">
                                    <label class="col-sm-3 control-label">Deal Type</label>                 
                                    <div class="col-md-6 col-sm-6 col-xs-12"> 
                                    <?php $dealType = $flight_deal['0']->deal_type;?>                   
                                      <select name="deal_type" class="form-control col-md-7 col-xs-12">
                                        <option value="" data-iconurl="" >Select Type</option>
                                        <option value="DOMESTIC" <?php echo  check_select($dealType, 'DOMESTIC'); ?> data-iconurl="" >Domestic</option>       
                                       </select>
                                 ...
                                 <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                       <input id="from" type="text" name="from" class="ft fromflight form-control col-md-7 col-xs-12" value="<?php echo $flight_deal['0']->deal_from_place ?>" required="required">
                                 ...
                                 <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                       <input id="from" type="text" name="to" class="ft fromflight form-control col-md-7 col-xs-12" value="<?php echo $flight_deal['0']->deal_to_place ?>"  required="required">
                                 ...
                                 <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                       <input  name="deal_start" id="deal_start" required type="text" class="ft form-control col-md-7 col-xs-12 forminput date_picker"  value="<?php echo $flight_deal['0']->deal_start; ?>" placeholder="Start Date" readonly />
                                    </div>
                                    </div>
                                    <div class="item form-group">
                                    <label for="Check-out" class="control-label col-md-3 col-sm-3 col-xs-12">Deal End</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                       <input type="text" name="deal_end" id="deal_end" required class="ft form-control col-md-7 col-xs-12 forminput date_picker" value="<?php echo $flight_deal['0']->deal_end; ?>" placeholder="End Date" readonly />
                                    </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="select2 ft form-control" name="airline" required>
                                            <option value="">Select</option>
                                            <?php foreach($airline as $airlinedata){ ?>
                                                <option <?php if($airlinedata->airline_code == $flight_deal['0']->airline) { echo "selected"; } ?> value="<?php echo $airlinedata->airline_code; ?>"><?php echo $airlinedata->airline_name; ?></option>
                                            <?php } ?>
                                        </select>
                                 ...
                                 <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="price" type="number" name="price" value="<?php echo $flight_deal['0']->deal_offered_price ?>"   class="form-control col-md-7 col-xs-12" required="required">
                                  ...
                                  <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="offer_text" type="text" name="offer_text" class="form-control col-md-7 col-xs-12" value="<?php echo $flight_deal['0']->offered_text ?>" required="required">
                                 ...
                                 <div class="item form-group">
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-12">
                                       <img src="<?php echo WEB_URL.'uploads/flightdeal/'.$flight_deal['0']->deal_image ?>" width="150" height="100">
                                    </div>
                                    <div class="col-md-3 col-sm-6 col-xs-12">
