              ...
              <?php }elseif($status=='0'){?>
               ...
               <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                            <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Promo code by %</a>
                                            </li>
                                            <li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab"  aria-expanded="false">Promo code by amount</a>
                                            </li>
                                            
                                        </ul>
                                        <div id="myTabContent" class="tab-content">
                                            <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab"><form class="form-horizontal form-label-left" novalidate method="post" action="<?php echo WEB_URL; ?>promo/add_promo_new" enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select  name="user_type" class="form-control col-md-7 col-xs-12 user_type" id="user_type">
                                                    <?php foreach($user_type as $udata):
                                                         if ($udata->user_type_id==4) {
                                                             continue;
                                                         }
                                                        ?>
                                                        <option data-id="<?=$udata->user_type_name?>" value="<?=$udata->user_type_id?>"><?=$udata->user_type_name?></option>
                                                    <?php endforeach;?>
                                         ...
                                         <div class="item form-group" id="staff_user">
                                          ...
                                          <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="promo_code" type="text" name="promo_code"  class="form-control col-md-7 col-xs-12" value="<?php echo $promo_code; ?>" required="required">
                                            </div>
                                          </div>
                                        <div class="item form-group">
                                            <label for="description" class="control-label col-md-3">Description</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="description" type="text" name="description"  class="form-control col-md-7 col-xs-12" value="<?php echo @$description; ?>" required="required">
                                            </div>
                                         </div>
                                          <!-- <div class="item form-group">
                                            <label for="minimum_amount" class="control-label col-md-3">Minimun Amount</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="minimum_amount" type="number" name="minimum_amount"  class="form-control col-md-7 col-xs-12" value="<?php echo @$minimum_amount; ?>" required="required">
                                            </div>
                                         </div>
                                         <div class="item form-group">
                                            <label for="promo_amount" class="control-label col-md-3">Maximum Range</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="promo_amount" type="text" name="maximum_amount"  class="form-control col-md-7 col-xs-12" value="" required="required">
                                            </div>
                                        </div> -->
                                          <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select  name="module_type" class="form-control col-md-7 col-xs-12 module_type" onchange="removeAirline(this.value)">
                                                    <?php foreach($module_arr as $m_key=>$m_value):?>
                                         ...
                                         <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select  name="promo_code_type" class="form-control col-md-7 col-xs-12" onchange="promocodetype(this.value)">
                                                        <option value="single" data-iconurl="">Single</option>
                                                        <option value="multiple" data-iconurl="">Multiple</option>
                                         ...
                                         <div class="item form-group limit_promo" >
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="limit" type="number" name="limit"  class="form-control col-md-7 col-xs-12" value="2">
                                            </div>
                                          </div>
                                         <div class="item form-group airline_codes" id="airlinwise">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select name="airline_code" class="form-control col-md-7 col-xs-12 select2">
	...
	<script>
        ...
        $(".select2").select2();
                                          ...
                                          <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="discount" type="number" name="discount"  class="form-control col-md-7 col-xs-12" value=""  maxlength="3" pattern="[0-9.]" required>
                                            </div>
                                          </div>
                                          <div class="item form-group">
                                            <label for="exp_date" class="control-label col-md-3">Expiry Date</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="single_cal4" type="text" name="exp_date"  class="form-control col-md-7 col-xs-12" value="" readonly required>
                                            </div>
                                          </div>
                                        ...
                                        <div class="col-md-3"></div>
                                          ...
                                          <!-- <label for="same_airport"class="same_airport_b2c">
                                              <input class="form-control chckbox same_airport" value="2" type="checkbox" id="same_airport_b2c" name="b2c_airport" />
                                             Show b2c Dashboard
                                          </label>

                                          <label for="same_airport" class="same_airport_b2b">
                                          ...
                                          <!-- <div id="dvPassport" style="display: none">
                                            ...
                                            <div class="col-md-3">
                                              <h4>Browse file:</h4>
                                              <input type="file" id="pic_b2b" name="pic_b2b"  />
                                            </div>
                                          </div> -->
                                            <!-- <div class="col-md-2 col-sm-2 col-xs-12">
                                                <div class="chck-input">
                                           <input class="form-control chckbox" id="same_airport" name="same_airport" type="checkbox" onchange="enableText(this)">
                                           <span>Show b2c Dashboard</span>
                                         </div>
                                            </div> -->
                                            <!-- <div class="col-md-2 col-sm-2 col-xs-12">
                                                <div class="chck-input">
                                           <input class="form-control chckbox" id="same_airport" name="same_airport" type="checkbox">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
                                               <form id="add_new_promo" class="form-horizontal form-label-left" novalidate method="post" action="<?php echo WEB_URL; ?>promo/add_promo_new_amount" enctype="multipart/form-data" >
                                         ...
                                         <div class="item form-group" id="agent_user2">
                                            <label for="user_id" class="control-label col-md-3">User List</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select  name="agent_user_id" class="form-control col-md-7 col-xs-12 user">
                                                    <option value="">All</option>
                                         ...
                                         <div class="item form-group" id="staff_user2">
                                            <label for="user_id" class="control-label col-md-3">User List</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select  name="staff_user_id" class="form-control col-md-7 col-xs-12 user">
                                                    <?php foreach($staff_user as $udata):?>
                                                        <option value="<?=$udata->user_id?>"><?=$udata->user_name?> - <?=$udata->user_email?></option>
                                                    <?php endforeach;?>
                                                </select>
                                         ...
                                         <div class="item form-group airline_codes" id="airlines1">
                                          ...
                                          <!-- <div class="item form-group">
                                            <label for="promo_amount" class="control-label col-md-3">Minimun Range</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="promo_amount" type="text" name="promo_amount"  class="form-control col-md-7 col-xs-12" value="" required="required">
                                            </div>
                                        </div>
                                         <div class="item form-group">
                                            <label for="promo_amount" class="control-label col-md-3">Maximum Range</label>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="discount" type="text" name="discount"  class="form-control col-md-7 col-xs-12" value=""  pattern="[0-9.]" required>
                                            </div>
                                        </div>
                                          <div class="item form-group">
                                            <label for="exp_date" class="control-label col-md-3">Expiry Date</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="single_cal5" type="text" name="exp_date"  class="form-control col-md-7 col-xs-12" value="" readonly required>
                                            </div>
                                          </div>
                                        ...
                                        <div class="col-md-3"></div>
                                           ...
                                           <span>Same Location</span>
                                            ...
                                            <!-- <label for="same1_airport">
                                             ...
                                             <!--  <label for="amount_b2b">
                                              <input class="form-control chckbox" type="checkbox" id="amount_b2b" name="amount_b2b" />
                                             Show b2b Dashboard
                                            </label> -->
                                          ...
                                          <!-- <div id="b2b_div" style="display: none">
                                            <div class="col-md-3"></div>
                                            <div class="col-md-3">
                                              <h2>Browse file:</h2>
                                              <input type="file" id="img_b2b" name="img_b2b" />
                                            </div>
                                          </div> -->
                                        </div>
                                        <div class="form-group">
...
$('.limit_promo').hide();
    $('#user_type').on('change', function() {
      ...
      if(val == 'STAFF')
      {
        ...
        $('.same_airport_b2c').hide();
          $('.same_airport_b2b').show();
          $('#staff_user').hide();
          $('#agent_user').show();
      }else{
         $('.same_airport_b2c').show();
          $('.same_airport_b2b').hide();
          $('#staff_user').hide();
          $('#agent_user').hide();
      }
    });
