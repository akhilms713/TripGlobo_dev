...
<style>
.top_search, .input-group{ float:right;
                        ...
                        <div class="title_right">
                            <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                                <div class="input-group" >
                                     <a class="btn btn-success" href="<?php echo WEB_URL; ?>staff/staff_list"><i class="fa fa-edit m-right-xs"></i> Back</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="profile_img">
                                            ...
                                            <div id="crop-avatar">
                                                ...
                                                <div class="avatar-view" title="Change the avatar">
                                                    <img src="<?php echo WEB_FRONT_URL.'photo/users/'.$user->profile_picture; ?>" alt="Avatar">
                                         ...
                                         </div><h3><?php echo $user->user_name; ?></h3>
											<div class="col-md-6 col-sm-6 col-xs-12 profile_left">
                                        <ul class="list-unstyled user_data">
                                            <li><i class="fa fa-map-marker user-profile-icon"></i> <?php echo $user->address; ?>, <br/><?php echo $user->city_name; ?>, <?php echo $user->state_name; ?>,  <?php echo $user->zip_code; ?> - <?php echo $user->country_name; ?>
                                            </li>

                                            <li>
                                                <i class="fa fa-briefcase user-profile-icon"></i> 
												<?php echo $user->user_email_id; ?>
                                            </li>

                                            <!--<li class="m-top-xs">
                                                <i class="fa fa-external-link user-phone-icon"></i>
                                               <?php echo $user->home_phone; ?>
                                            </li>-->
                                             <li class="m-top-xs">
                                                <i class="fa fa-external-link user-phone-icon"></i>
										 ...
										 </div><a class="btn btn-success" href="<?php echo WEB_URL; ?>staff/edit_profile/<?php echo $user->user_id; ?>"><i class="fa fa-edit m-right-xs"></i>Edit Profile</a>
                                         <a class="btn btn-success" href="<?php echo WEB_URL; ?>staff/staff_update_password/<?php echo $user->user_id; ?>"><i class="fa fa-edit m-right-xs"></i>Change Password</a>
                                        <br />
