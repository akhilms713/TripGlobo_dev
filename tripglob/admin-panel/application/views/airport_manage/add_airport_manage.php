                              ...
                              <form class="form-horizontal form-label-left input_mask"  method="post" action="" >
                                 ...
                                 <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                       <select id="airlineCountry" name="country" class="ft airlineCountry form-control col-md-7 col-xs-12" required="required" onChange="getCity(this.value)">
                                 ...
                                 <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                       <input id="airport_name" type="text" name="airport_name" class="ft airport_name form-control col-md-7 col-xs-12" value="" required="required">
                                    </div>
                                 </div>
                                 ...
                                 <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                       <input id="airport_code" type="text" name="airport_code" class="ft airport_code form-control col-md-7 col-xs-12" value="" required="required">
                                    </div>
                                 </div>
