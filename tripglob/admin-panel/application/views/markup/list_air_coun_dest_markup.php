      ...
      <body class="nav-md">
        ...
        <div class="container body">
			...
			<ol class="breadcrumb bc-3">						
				...
				<li class="active" style="float:right;"><a href="<?php echo site_url()."markup/add_air_coun_dest_markup"; ?>">Add New Markup</a></li>
			</ol>
				...
				<table class="table table-bordered datatable" id="api_list">
					...
					<?php if($markup!=''){ for($a=0;$a<count($markup);$a++){ ?>
						<tr>
							...
							<td><?php echo ($markup[$a]->airline_name!='')?$markup[$a]->airline_name:'All'; ?></td>
							...
							<td class="center">
								<?php if($markup[$a]->status == "ACTIVE"){ ?>
									<a href="<?php echo site_url()."markup/inactive_air_coun_dest_markup/".base64_encode(json_encode($markup[$a]->markup_details_id)); ?>" class="btn btn-orange btn-sm btn-icon icon-left"><i class="entypo-eye"></i>InActive</a>
								<?php }else{ ?>
									<a href="<?php echo site_url()."markup/active_air_coun_dest_markup/".base64_encode(json_encode($markup[$a]->markup_details_id)); ?>" class="btn btn-green btn-sm btn-icon icon-left"><i class="entypo-check"></i>Active</a>
								<?php } ?>
								<a href="<?php echo site_url()."markup/edit_air_coun_dest_markup/".base64_encode(json_encode($markup[$a]->markup_details_id)); ?>" class="btn btn-default btn-sm btn-icon icon-left"><i class="entypo-pencil"></i>Edit</a>			
								<a onclick="return confirm('Are you sure you want to delete ?');" href="<?php echo site_url()."markup/delete_air_coun_dest_markup/".base64_encode(json_encode($markup[$a]->markup_details_id)); ?>" class="btn btn-danger btn-sm btn-icon icon-left"><i class="entypo-cancel"></i>Delete</a>
							</td>
						</tr>
					<?php } } ?>												
					</tbody>
