								...
								<div class="form-group hide">
									...
									<div class="col-sm-5">
										<select name="domain" class="select2" required>
											...
											<option value="<?php echo $domain[$d]->domain_details_id; ?>" data-iconurl="" <?php if($domain[$d]->domain_details_id == $markup->domain_details_id){ echo "selected"; } ?>><?php echo $domain[$d]->domain_name; ?></option>
											<?php }} ?>
										</select>
									</div>
								</div>
