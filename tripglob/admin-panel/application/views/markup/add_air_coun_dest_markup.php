						...
						<div class="panel-body">							
							<form method="post" action="<?php echo site_url()."markup/add_air_coun_dest_markup"; ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">				
								<div class="form-group">
									...
									<div class="col-sm-5">
										<select name="user_type" class=" form-control" required onchange="chaeck_user(this.value)">
								...
								<!--	<div class="col-sm-5">-->
								<!--		<select name="domain" class="" required>-->
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<select name="product" id="product" class=" form-control" required onchange="removeField(this.value)">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<select name="api" class=" form-control" required id="getApi">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<select onchange="makup_type_details(this.value)" id="markup_type" name="markup_type" class=" form-control" required>
								...
								<div class="form-group" id="trip">
									...
									<div class="col-sm-5">
										<select name="trip_type" onchange="trip_type_change(this.value)"  class=" trip_type form-control" required>
								...
								<div class="form-group" id="source_class" style="display: none;">
									...
									<div class="col-sm-5">
										<select name="onward_class"  class=" form-control" required>
								...
								<div class="form-group" id="destination_class" style="display: none;">
									...
									<div class="col-sm-5">
										<select name="return_class"  class=" form-control" required>
					                     <option value="All">Any</option>
					                      <option value="Economy">Economy</option>
					                      <option value="PremiumEconomy">Premium Economy</option>
					                      <option value="Business">Business</option>
								...
								<div class="form-group">
									<label for="field-1" class="col-sm-3 control-label">Markup Type</label>									
									<div class="col-sm-5">
										<select  name="markup_value_type" class=" form-control" required onchange="change_val(this.value)">
