               ...
               <div class="">
                  ...
                  <div class="row">
                     <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                           <div class="x_title">
                              <h2>Add Bus Trip <small> </small></h2>
                              <div class="clearfix"></div>
                           </div>
                           <div class="x_content">
                              <form class="form-horizontal form-label-left" novalidate method="post"action="<?php echo WEB_URL; ?>special_trip/add_bus_trip" enctype="multipart/form-data">
                                <div class="item form-group">
                                    ...
                                    <div class="item form-group">
                                    <label for="" class="control-label col-md-3 col-sm-3 col-xs-12">Travels Name</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                         <input id="travelsname" type="text" name="travelsname"  class="form-control col-md-7 col-xs-12" value="" required="required">
                                         </div>
                                    </div>
                                 <div class="item form-group">
                                    <label for="City Name" class="control-label col-md-3">From </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                         <input id="from" name="from" type="text" class=" ft frombus mytextbox iconLoc contr_form form-control col-md-7 col-xs-12" placeholder="From, Bus" style="" value="<?php if(isset($origin)){ echo $origin; } ?>" autoComplete="off" aria-autocomplete="list"/>
                                 ...
                                 <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input class="ft departbus mytextbox iconLoc contr_form pad_twofive form-control col-md-7 col-xs-12" name="to"  id="to"  placeholder="To, Bus" value="<?php echo $destination;?>" autoComplete="off" aria-autocomplete="list" type="text" />
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                         <input id="single_cal4" type="text" name="departure_date"  class="form-control col-md-7 col-xs-12" value="" required="required">
                                         </div>
                                    </div>
                                    <div class="item form-group">
                                    <label for="Check-out" class="control-label col-md-3 col-sm-3 col-xs-12">Arrival Date</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="single_cal5" type="text" name="arrival_date"  class="form-control col-md-7 col-xs-12" value="" required="required">
                                ...
                                <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <!--<input id="boarding" type="text" name="boarding[]" class="form-control col-md-7 col-xs-12" required="required" placeholder="Boarding Point">-->
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <!--<input id="droping" type="text" name="droping[]" class="form-control col-md-7 col-xs-12" required="required" placeholder="Droping Point">-->
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="amount" type="number" name="amount" class="form-control col-md-7 col-xs-12" required="required" placeholder="Amount">
                                            </div>
                                        </div>
                                        <div class="" id="addModuleField"></div>
                                        <div class="item form-group">
      ...
      <script type="text/javascript">
         ...
         /* flight */  
           ...
           $(".fromflight").autocomplete({
              source: api_url+"general/bus_stations",
