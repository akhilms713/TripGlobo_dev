...
<!--<form class="form-horizontal form-label-left"  method="post" action="<?php echo WEB_URL; ?>staff/add_staff_do" enctype="multipart/form-data">-->
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                         <input id="travelsname" type="text" name="travelsname" value="<?php echo $bus_details->travels_name;?>"  class="form-control col-md-7 col-xs-12" value="" required="required">
                                         </div>
                                    </div>
                                        ...
                                        <div class="item form-group">
                                            <img src="https://tripglobo.com/admin-panel/uploads/special_trip/<?=$bus_details->bus_image?>" alt="no images" style="width:10%">
                                        </div>
                                        <div class="item form-group">
