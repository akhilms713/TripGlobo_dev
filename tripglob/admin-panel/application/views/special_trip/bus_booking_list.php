                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <table id="example" class="table table-striped responsive-utilities jambo_table">
                                    ...
                                    <tbody>
                                        <?php 
                                        // var_dump($bus_request_list); 
										$i=1;
										if(!empty($bus_request_list))
										{
                                        foreach($bus_request_list as $val)
                                        {
                                           ?>
                                          ...
                                          <td><?= $val['to_location'];?></td>
                                           ...
                                           <td class=""><?php 
                                             ...
                                             <td>
                                           <select onchange="updateStatus(this.value,<?php echo $val['special_bus_id']; ?>)">
...
<script>
    ...
    {
        	$.ajax({
				url: '<?php echo WEB_URL; ?>special_trip/b2c_userReq_status_update',
				type: "post",
