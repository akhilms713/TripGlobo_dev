               ...
               <div class="">
                  ...
                  <div class="row">
                     <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                           <div class="x_title">
                              <h2><a href="<?php echo WEB_URL; ?>special_trip/all_hotel_trip">Hotel Trip List</a><small> </small></h2>
                              <div class="clearfix"></div>
                           </div>
                           <div class="x_content">
                              <form class="form-horizontal form-label-left" novalidate method="post"action="<?php echo WEB_URL; ?>special_trip/add_hotel_trip" enctype="multipart/form-data">
                                <div class="item form-group">
                                         ...
                                         <div class="item form-group">
                                    <label for="City Name" class="control-label col-md-3">Hotel Name </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="hotelname" name="hotelname" type="text"  class="form-control col-md-7 col-xs-12" required/>
                                 ...
                                 <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="from" name="from" type="text" value="<?php echo $hotel_details->city_name;?>" class=" ft hotelCityIp mytextbox iconLoc contr_form form-control col-md-7 col-xs-12" placeholder="From" style="" value="<?php if(isset($origin)){ echo $origin; } ?>" autoComplete="off" aria-autocomplete="list"required/>
                                 ...
                                 <!-- <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                         <input id="single_cal4" type="text" name="checkin_date"  class="form-control col-md-7 col-xs-12" value="" required="required">
                                         </div>
                                    </div>
                                    <div class="item form-group">
                                    <label for="Check-out" class="control-label col-md-3 col-sm-3 col-xs-12">checkout Date</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="single_cal5" type="text" name="checkout_date"  class="form-control col-md-7 col-xs-12" value="" required="required">
                                     ...
                                     <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="departure" type="time" name="checkin_time"  class="form-control col-md-7 col-xs-12" required="required" placeholder="Start Time" value="00:00">
                                            </div>  
                                        </div>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="arrival" type="time" name="checkout_time" class="form-control col-md-7 col-xs-12" required="required" placeholder="End Time" value="00:00">
                                            </div>
                                        </div>
                                ...
                                <!-- <div class="item form-group">
                                      ...
                                      <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="image" type="file" name="image" class="form-control col-md-7 col-xs-12" required="required" placeholder="Image"required/>
                                            </div>
                                        </div>
                                          <div class="item form-group">
                                            <label for="zip_code" class="control-label col-md-3 col-sm-3 col-xs-12">Rating</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="rating" type="text" name="rating" class="form-control col-md-7 col-xs-12" required="required" placeholder="Rating"required/>
                                            </div>
                                        </div>
                                          <div class="item form-group">
                                            <label for="zip_code" class="control-label col-md-3 col-sm-3 col-xs-12">Address</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="address" type="text" name="address" class="form-control col-md-7 col-xs-12" required="required" placeholder="Address"required/>
                                            </div>
                                        </div>
      ...
      <script type="text/javascript">
         ...
         /* flight */  
           ...
           $(".fromflight").autocomplete({
              source: api_url+"general/get_hotel_cities",
