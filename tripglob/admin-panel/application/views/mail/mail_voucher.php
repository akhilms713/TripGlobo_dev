                                    ...
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                       <tr>
                                          <td align="left" width="100%">
                                             <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                   <td align="left"><img src="http://108.170.38.171/vietnet/assets/theme_dark/images/logo.png" alt="China Easter Logo" /></td>
                                                   <td align="right">
                                                      <div class="confirmtionltr" style="text-align:center;">Confirmation ff Voucher</div>
                                                   </td>
                                                </tr>
                                             </table>
                                             <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                     ...
                                                                     <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                       <td width="100%" align="left" valign="top">
                                                                                          <table width="100%" border="0" cellspacing="1" cellpadding="7" bgcolor="#FFFFFF">
                                                                                             <tbody>
                                                                                                <tr>
                                                                                                   <td width="100%" bgcolor="#dd2a1b" style="color: #ffffff; border-bottom: 1px solid #eee;">
                                                                                                         ...
                                                                                                         <table width="100%" border="0" cellspacing="0" cellpadding="7" bgcolor="#FFFFFF" class="paddingTableTable">
                                                                                                            <tbody>
                                                                                                               <tr style="font-size:12px; color:#666;">
                                                                                                                  <td width="25%" style="font-weight:bold;border-right: 1px solid #eee;">Vietnet Confirmation No</td>
                                                                        ...
                                                                        <?php
                                                                           $price_data = json_decode($b_data->PricingDetails,1);
                                                                            ...
                                                                            $adult=$ADT = $price_data[0]['PriceInfo']['PassengerFare']['ADT']['count'];
                                                                            if(isset($price_data[0]['PriceInfo']['PassengerFare']['CNN']['count'])){
                                                                              $child=$CHD=$price_data[0]['PriceInfo']['PassengerFare']['CNN']['count'];
                                                                            }else{
                                                                              $child=$CHD = 0;
                                                                            }
                                                                              ...
                                                                              <table width="100%" border="0" cellspacing="0" cellpadding="7" bgcolor="#FFFFFF" class="paddingTableTable">
                                                                                 <tbody>
                                                                                    <tr style="font-size:12px; color:#666;">
                                                                                       ...
                                                                                       <td width="25%" style="border-right: 1px solid #eee;"><span style="font-size:12px; color:#333; font-weight:normal; padding: 5px 0;display: block;"><?php echo "Price: ";?><?php echo "$"; echo  $totalFareAmount; ?></span></td>
                                                                                    </tr>
                                                                                 </tbody>
                                                                              </table>
                                                                           </td>
                                                                        ...
                                                                        <tr>
                                                                           <td align="center" bgcolor="#ffffff" class="padding1" style="border: 1px solid #eee; padding:0px;">
                                                                              <table width="100%" border="0" cellspacing="0" cellpadding="7" bgcolor="#FFFFFF" class="paddingTableTable">
                                                                                 <tbody>
                                                                                    <tr>
                                                                                       <td colspan="5" bgcolor="#dd2a1b" style="color: #ffffff; border-bottom: 1px solid #eee;">
                                                                                          <div class="dterser">
                                                                                    ...
                                                                                    <?php 
                                                                                       $segment_data = json_decode($b_data->segment_data,1);
                                                                                        // echo "<pre>"; print_r($segment_data); echo "</pre>"; 
                                                                                    ...
                                                                                    <tr style="font-size:12px; color:#666;">
                                                                                       <td width="25%" rowspan="2" style="border-right: 1px solid #eee;">
                                                                                          <div class="padwithbord">
                                                                                             <div style="padding:5px 0;" class="leftflitmg"> <img src="http://www.cleartrip.com/images/logos/air-logos/<?php echo $segment_data[$s]['marketingCarrier'][$ss];?>.png" />  </div>
                                                                                             <div style="padding:5px 0;" class="fligtdetss"> <?php echo  $segment_data[$s]['airlineName'][$ss];?> <br />
                                                                                                <?php echo $segment_data[$s]['marketingCarrier'][$ss];?> <?php echo $segment_data[$s]['flightOrtrainNumber'][$ss];?> 
                                                                                             </div>
                                                                                             <div style="padding:5px 0;" class="opfligt"> Operated by: <strong><?php echo $segment_data[$s]['airlineName'][$ss];?></strong></div>
                                                                                             <div style="padding:5px 0;" class="opfligt">Duration: <strong><?php echo $segment_data[$s]['durationFinalEft'][$ss]?></strong></div>
                                                                                          </div>
                                                                                       </td>
                                                                                       <td bgcolor="#FFFFFF" style="border-bottom:1px solid #EEE; border-right:1px solid #EEE; vertical-align:top;">
                                                                                          <span style="font-size:14px; color:#333; font-weight:bold; padding: 5px 0;display: block;"><?php echo $segment_data[$s]['locationIdDeparture'][$ss];?></span>
                                                                                          <?php echo $this->Flight_Model->get_airport_name($segment_data[$s]['locationIdDeparture'][$ss]);?>
                                                                                       </td>
                                                                                       <td bgcolor="#FFFFFF" style="border-bottom:1px solid #EEE; border-right:1px solid #EEE;vertical-align:top;"><span style="font-size:14px;color:#333; font-weight:bold;display: block;padding: 5px 0;"><?php echo $segment_data[$s]['locationIdArival'][$ss];?></span>
                                                                                          <?php echo $this->Flight_Model->get_airport_name($segment_data[$s]['locationIdArival'][$ss]);?>
                                                                                       </td>
                                                                                       <td width="25%" rowspan="2" bgcolor="#FFFFFF">
                                                                                          <span style="display:block; padding:5px 0;"><strong>Aircraft:</strong>
                                                                                          <?php echo $segment_data[$s]['equipmentType'][$ss];?> </span> <br/>
                                                                                          <span style="display:block; padding:5px 0;"><strong>Stop(s):</strong> <?php echo $segment_data[$s]['stops']; echo "Stops";?></span><br/>
                                                                                       </td>
                                                                                    </tr>
                                                                                    <tr colspan="5">
                                                                                       <td bgcolor="#FFFFFF" style="border-right:1px solid #EEE;vertical-align:top;padding-bottom:5px;"><span style="display:block; padding:5px 0;">Departing At:</span>
                                                                                          <span style="font-size:13px; font-weight:bold;"><?php echo ($segment_data[$s]['DepartureTime'][$ss]) ;?></span>
                                                                                       </td>
                                                                                       <td bgcolor="#FFFFFF" style="border-right:1px solid #EEE;vertical-align:top;padding-bottom:5px;"><span style="display:block; padding:5px 0;">Arriving At:</span>
                                                                                          <span style="font-size:12px; font-weight:bold;"><?php echo  ($segment_data[$s]['ArrivalTime'][$ss]) ;?></span>
                                                                                       </td>
                                                                                    </tr>
                                                                                    <?php
                                                                                       }
                                                            ...
                                                            <tr>
                                                               <td colspan="2">
                                                                  <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" class="detailtbl">
                                                                     <tbody>
                                                                        <tr>
                                                                           <td bgcolor="#dd2a1b" style=" color: #ffffff;border-bottom: 1px solid #eee;">
                                                                     ...
                                                                     <tbody>
                                                                        ...
                                                                        <tr>
                                                                           <td width="50%" align="left" style="padding:10px">
                                                                              <div style="color: #666; display: block; line-height: 20px; overflow: hidden; text-align: right;float: left; font-family: Helvetica Neue, Helvetica, Arial, sans-serif;">
                                                                              <table width="100%" border="0" cellspacing="1" cellpadding="7" bgcolor="#FFFFFF" class="con_addr_bottom">
                                                                                 <td colspan="2" bgcolor="#dd2a1b" style="color: #ffffff;border-bottom: 1px solid #eee;">
                                                                                       <div class="snotes" style=" text-align: left;font-size:13px;">Customer Billing Details</div>
                                                                                 </td>
