                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Add New Top Deals <small> </small></h2>
                                    
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">

                                    <form class="form-horizontal form-label-left" novalidate method="post" action="<?php echo WEB_URL; ?>top_deals/add_topdeals_do" enctype="multipart/form-data">
                                          ...
                                          <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                 <input id="from" type="text" name="from" class="ft fromflight form-control col-md-7 col-xs-12" value="" required="required">
                                            </div>
                                        </div>
                                         <div class="item form-group">
                                            <label for="Offer" class="control-label col-md-3">Offer Title</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="offer" type="text" name="offer_title"  class="form-control col-md-7 col-xs-12" required="required">
                                            </div>
                                        </div>
                                         <div class="item form-group">
                                            <label for="Offer Desc" class="control-label col-md-3">Offer Short Desc.</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="offer_desc" type="text" name="offer_desc"  class="form-control col-md-7 col-xs-12" required="required">
                                            </div>
                                        </div>
                                         <div class="item form-group">
                                            <label for="Special Title" class="control-label col-md-3">Special Title</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="special_title" type="text" name="special_title"  class="form-control col-md-7 col-xs-12" required="required">
                                            </div>
                                        </div>
                                         <div class="item form-group">
                                            <label for="Special Desc" class="control-label col-md-3">Special Desc.</label>
                                                ...
                                                <textarea class="form-control ckeditor" name="special_desc" required="required"></textarea>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input  name="depature" id="depature" required type="text" class="ft  form-control col-md-7 col-xs-12 forminput date_picker"  value="" placeholder="Checkin Date" readonly />
                                            </div>
                                        </div>
                                       <div class="item form-group">
                                            <label for="Check-out" class="control-label col-md-3 col-sm-3 col-xs-12">Check-out</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" name="return" id="return" required class="ft  form-control col-md-7 col-xs-12 forminput date_picker" value="" placeholder="Chekout Date" readonly />
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="link" type="url" name="link"   class="form-control col-md-7 col-xs-12" required="required">
                                            </div>
                                        </div>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="position" type="number" name="position"   class="form-control col-md-7 col-xs-12" required="required">
                                            </div>
                                        </div>
