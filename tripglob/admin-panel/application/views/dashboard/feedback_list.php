<?php //echo "<pre>",print_r($tour_view_data);?>
<!DOCTYPE html>
<html lang="en">
<head>
                    ...
                    <div class="">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                               ...
                               if(!empty($feedback_data)){ $c=1;
                                foreach($feedback_data as $k=>$val){ ?>
                                        <tr class="even pointer">
                                            <td class=" "><?php echo $c;?></td>
                                            <td><?php echo $val->feedback_name;?></td>
                                            <td><?php echo $val->feedback_email;?></td>
                                            <td><?php echo $val->feedback_booking;?></td>
                                            <td><?php echo $val->message;?></td>
                                            
                                          <!-- <td style="text-align: center">
                                          <a href="<?php //echo WEB_URL; ?>transfer_crs/edit_supplier_list/<?php echo $val->id; ?>">

                                            <a href="#" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
                                            <a href="<?php //echo WEB_URL; ?>transfer_crs/edit_supplier_list/<?php echo $val->id; ?>">  <i class="fa fa-pencil-square-o" title="Edit"></i></a>
...
$('.whiteip1').on('click', function() { 
    ...
    else
    {
        ...
        if(_id1.toString().length > 0 && !isNaN(_id1)) {
            ...
            $.ajax({
                url: '<?php echo WEB_URL; ?>transfer_crs/supplier_change_status/'+_id1+'/'+s_status1,
                type: "get",
...
$(document).on('click','#delete_template',function(){
                ...
                if(confirm("Are you sure want to delete?"))
                {
                   ...
                   //alert(id);die();
                    $.ajax({
                        type:"POST",
                       url: '<?php echo WEB_URL; ?>transfer_crs/delete_master_module/'+id,
                        data:{template_id : id},
