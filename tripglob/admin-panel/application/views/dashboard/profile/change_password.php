...
<body class="nav-md">
 ...
 <?php if($status=='1'){?>
              ...
              <?php }elseif($status=='0'){?>
               ...
               <?php } ?>
                                    <form class="form-horizontal form-label-left" novalidate method="post" action="<?php echo WEB_URL; ?>home/update_password">

                                            
                                          <div class="item form-group">
                                            <label for="opassword" class="control-label col-md-3">Old Password</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="opassword" type="password" name="opassword"  class="form-control col-md-7 col-xs-12" required="required">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6 col-md-offset-3">
												<a href="<?php echo base_url(); ?>" class="btn btn-primary ad-cancel"> Cancel</a>
