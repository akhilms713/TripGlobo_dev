                                ...
                                <div class="x_content">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                                        ...
                                        <div class="profile_img">
                                            ...
                                            <div id="crop-avatar">
                                                ...
                                                <div class="avatar-view" title="Change the avatar">
                                                    <img src="<?php echo PROJECT_LOGO; ?>" alt="Avatar">
                                                </div>
                                        ...
                                        <ul class="list-unstyled user_data">
                                            <li><i class="fa fa-map-marker user-profile-icon"></i> <?php echo $admin_profile_info->address; ?>, <br/><?php echo $admin_profile_info->city_name; ?>, <?php echo $admin_profile_info->state_name; ?>,  <?php echo $admin_profile_info->zip_code; ?> - <?php echo $admin_profile_info->country_name; ?>
                                            </li>
