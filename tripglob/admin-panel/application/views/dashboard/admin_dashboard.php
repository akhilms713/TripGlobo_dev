...
<head>
  ...
  <link rel="icon" href="https://tripglobo.com/beta1/assets/theme_dark/images/favicon.png" type="image/x-icon">
    ...
    <script src="<?php echo ASSETS; ?>css/fullcalendar/lib/moment.min.js"></script>
    <script src="<?php echo ASSETS; ?>js/Highcharts/js/highcharts.js" type="text/javascript"></script>
    <script src="<?php echo ASSETS; ?>css/fullcalendar/fullcalendar.min.js" type="text/javascript"></script>
    <link href="<?php echo ASSETS; ?>css/fullcalendar/fullcalendar.css" rel="stylesheet" />
                    ...
                    <div class="row">
                        ...
                        <!--calender start-->
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                <div class="dashboard_graph x_panel" style="height:400px !important;">
                                    <div class="row x_title">
                                        <div class="col-md-6">
                                            <h3>Booking Calender<small></small></h3>
                                        </div>
                                        <div class="col-md-6">
                                        </div>
                                    </div>
                                    <div class="x_content">
                                        <div class="demo-container" style="height:250px">
                                            <div id="booking-calendar" class="demo-placeholder" style="width: 100%; height:100%">
...
var labelColor = "#333";
    ...
    <script>
        $(document).ready(function() {
          ...
          function set_booking_event_list(start_date='',end_date='')
          {
            $.ajax({
              type: "POST",
              url:"<?php echo base_url(); ?>home/booking_events",
          ...
          function load_calendar(event_list)
          {
            $('#booking-calendar').fullCalendar({
              ...
              eventRender: function(event, element) {
                ...
                element.css({'font-size':'10px', 'padding':'1px', 'height':'300px !important'});
              ...
              viewRender : function (view, element) {
                    ...
                    $("#booking-calendar").fullCalendar('removeEvents');
                    set_booking_event_list(start_date,end_date);
                    set_event_list();
                }
            });
          }
