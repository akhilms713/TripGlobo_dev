                              ...
                              <form class="form-horizontal form-label-left input_mask"  method="post" action="" enctype="multipart/form-data">
                                 <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                       <input id="airlineName" type="text" required name="airline_name" class="ft airlineName form-control col-md-7 col-xs-12" value="<?php echo $airline_list->airline_name; ?>" required="required">
                                    </div>
                                 </div>
                                 ...
                                 <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                       <input id="airlineCode" type="text" required name="airline_code" class="ft airlineCode form-control col-md-7 col-xs-12" value="<?php echo $airline_list->airline_code; ?>" required="required">
                                    </div>
                                 </div>
                                 ...
                                 <div class="form-group">
                                    <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                                       <input type="hidden" name="airportId" value="<?php echo $airline_list->airline_list_id; ?>">
