...
// debug($cart['room_type']);exit();
$request_data=json_decode(base64_decode(unserialize($hotel_data['request'])),1)
   ...
   ?>
          ...
          <div class="container body" style="background: #fff;">
            <div class="main_container">
              ...
              <div class="clearfix"></div>
              <div class="full marintopcnt contentvcr" id="voucher-hotel">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          <td width="25%" rowspan="2" style="border-right: 1px solid #cccccc;"><div class="padwithbord">
                                            <div class="htl_vchrimg"> <img width="200px" height="200px" src="<?php echo $hotel_data['URL']; ?>" /> </div>
                                            <br />
                                            <div class="opfligt"> Room type: <strong><?php echo json_decode($cart->room_type,1)[0]; ?>,<?php echo $cart->description;?></strong></div>
                                          </div></td>
                                      ...
                                      <tr>
                                        <td><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" class="detailtbl">
                                          <tbody>
                                            ...
                                            <tr class="set_bordr">
                                              <td width="100%" align="left" style="background:#f1f1f1"> <?php  if (empty(json_decode($cart->cancel_policy,1))) {
                                                echo "Non Refundable";
                                                } else {
                                                foreach(json_decode($cart->cancel_policy,1) as $key_c =>$CancellationPolicyy){
              ...
              function PrintDiv() {    
   var voucher = document.getElementById('voucher-hotel');
