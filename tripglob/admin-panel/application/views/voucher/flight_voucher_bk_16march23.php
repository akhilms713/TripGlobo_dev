    ...
    <div class="container body">
        <div class="main_container">
          ...
          width: 323px;"><img src="<?php echo ASSETS;?>images/logo.png" width="250" alt="" ></div>
                ...
                <table style="margin:0 auto;background-color:#fff;font-size:14px;font-family:Arial,Helvetica,sans-serif" width="95%" cellspacing="0" cellpadding="0" border="0">
                    <tbody>
                        <tr>
                            <td style="padding:20px;" width="417" align="left">
                                Hi ,
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td style="font-size:14px;font-family:Tahoma,Geneva,sans-serif;padding:20px;" width="417" align="left">
                                          ...
                                          <div class="detail_section">
                                            ...
                                            <div class="col-xs-4 padflt widfty text-center">
                                              <span class="timlbl">
                                                ...
                                                <span class="flname">
                                                  <strong style="color: #1f91cd;font-weight: bold;display: block;"><?php echo $segment_data[$s]->Origin[$ss]; ?></strong> <span class="fltime" style="font-weight: bold;"><?php echo date("H:i", strtotime($segment_data[$s]->DepartureDateTime_r[$ss]));  ?></span></span>
                                              </span>
                                              <div class="clearfix"></div>
                                                                          <div class="clearfix"></div>
                                  ...
                                  <table style="font-family:Tahoma,Geneva,sans-serif;font-size:11px;padding:1% 1%;margin:0 auto;" width="95%" border="0">
                                      <tbody>
                                          ...
                                          <td valign="middle" align="right">
                                              <b style="font-size:15px;color:#1f91cd">Amount <?=BASE_CURRENCY_ICON?></b>
                                          </td>
                                          </tr>
                                          <tr>
                              ...
                              <?php 
                                ...
                                ?>  
                                    ...
                                    $pax_array['INF'] = 'Adult';
                                     ...
                                     <?php foreach($segment_data[0]->PCode as $key=>$val){ ?>           
                                       ...
                                       <tr>
                                          ...
                                          <td>&nbsp;&nbsp;&nbsp;</td>
                                          <td valign="middle" align="right" style="font-size:14px;">
                                          <?php 
                                          $total_pax = 0;
                                          $total_amount = 0;
                                          if($val=='ADT'){
                                     ...
                                     ?>
                                      ...
                                      <tr>
                                          ...
                                          <tr>
                                              <td valign="middle" align="left" style="font-size:14px;">Taxes & Fees</td>
                                              <td>&nbsp;</td>
                                              <td valign="middle" align="right" style="font-size:14px;"><?=BASE_CURRENCY_ICON.$val['total_tax']?></td>
                                          </tr>
                                    ...
                                    <?php } ?>
                                          ...
                                          <tr>
                                              <td valign="middle" align="left" style="font-size:14px;">Service Tax & Maintenance Charge</td>
                                              <td>&nbsp;</td>
                                              <td valign="middle" align="right" style="font-size:14px;"><?=BASE_CURRENCY_ICON.($booking_transaction->admin_markup+$booking_transaction->agent_markup)?></td>
                                          </tr>
                                      ...
                                      ?>
                                          <tr>
                                              <td valign="middle" align="left" style="font-size:14px;">Discount</td>
                                              <td>&nbsp;</td>
                                              <td valign="middle" align="right" style="font-size:14px;"><?=BASE_CURRENCY_ICON.$booking_transaction->discount?></td>
                                          </tr>
