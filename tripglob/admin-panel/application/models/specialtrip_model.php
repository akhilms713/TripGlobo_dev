...
{
    $query = "select * from b2c_special_bus_trip join bus_trip on  bus_trip.bus_trip_id=b2c_special_bus_trip.bus_trip_ids";
    return $this->db->query($query)->result_array();
//   $this->db->select('*');
...
{
    	$query = "select * from b2c_special_hotel_trip join hotel_trip on  hotel_trip.hotel_trip_id=b2c_special_hotel_trip.hotel_trip_ids";
      	return $this->db->query($query)->result_array();
