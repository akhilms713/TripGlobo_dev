...
class Promo_Model extends CI_Model {
   ...
   public function get_user_list_details_new($user_type_id){
   	$query = $this->db->query("SELECT UL.user_email_id FROM user_details AS UD LEFT JOIN user_login_details AS UL ON UL.user_id=UD.user_id WHERE UL.user_type_id=".$user_type_id." AND UD.status='ACTIVE'");
   	return $query->result();
   	// debug($execute_query->num_rows());exit();
