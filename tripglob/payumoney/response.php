<?php
$postdata = $_POST;
// echo "<pre>"; print_r($postdata); exit('RESPONSE');
$msg = '';
if (isset($postdata ['key'])) {
	...
	$send_post_data=base64_encode(json_encode($postdata));
	header("location:".'https://tripglobo.com/booking/payumoney_payment_response/'.$send_post_data);
